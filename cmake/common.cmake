...
namespace @IMPL_NAMESPACE@ {
    ...
    foreach(INDEX RANGE ${LAST_INDEX})
		...
		set(RETVAL_FMT "$<CONFIG>/${BASE_KEY}")
		set(RETVAL_ARGS "")
		set(CX_CAPACITY 0)
		...
		string(CONFIGURE [=[
		nbl::core::detail::append_printf_s<NBL_CORE_UNIQUE_STRING_LITERAL_TYPE("@RETVAL_FMT@")>(retval@RETVAL_ARGS_STR@);
...
@RETVAL_EVAL_CONSTEXPR@
		...
		function(GENERATE_KEYS PREFIX CAP_INDEX CAPS_EVAL_PART)
			if(NUM_CAPS EQUAL 0 OR CAP_INDEX EQUAL ${NUM_CAPS})
				...
				set(HEADER_ONLY_LIKE "${CONFIG_FILE}" "${TARGET_INPUT}")
				if(NBL_NSC_OUT_FILES)
