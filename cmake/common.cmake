...
function(nbl_project_handle_json_config)
	...
	if(EXISTS "${_NBL_JSON_CONFIG_FILEPATH_}")		
		...
		file(RELATIVE_PATH NBL_PYTHON_FRAMEWORK_MODULE_PATH_REL "${NBL_TEMPLATE_JSON_DIR}" "${NBL_PYTHON_MODULE_ROOT_PATH}")
		...
		target_sources(${EXECUTABLE_NAME} PUBLIC "${_NBL_JSON_SCRIPTPATH_ABS_}")
		source_group("${NBL_PFT_SOURCE_GROUP_NAME}/Python/Interface" FILES "${_NBL_JSON_SCRIPTPATH_ABS_}")
