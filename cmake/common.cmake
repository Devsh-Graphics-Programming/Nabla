...
function(nbl_project_handle_json_config)
	...
	set(_NBL_JSON_CONFIG_FILEPATH_ "${NBL_TEMPLATE_JSON_DIR}/config.json")
	...
	if(EXISTS ${_NBL_JSON_CONFIG_FILEPATH_})		
		file(READ "${NBL_TEMPLATE_JSON_DIR}/config.json" _NBL_JSON_TOP_CONFIG_CONTENT_)
		...
		if(_NBL_JSON_DATA_LEN_ GREATER_EQUAL 1)
			...
			foreach(_NBL_IDX_ RANGE ${_NBL_STOP_})
				...
				# "${_NBL_JSON_FIELD_TRAVERSAL_}.command" string
				NBL_JSON_READ_VALIDATE_POPULATE("${_NBL_JSON_FIELD_TRAVERSAL_}" command STRING "${_NBL_JSON_DATA_LIST_ELEMENT_CONTENT_}")
		...
		if(_NBL_JSON_PROFILES_LEN_ GREATER_EQUAL 1)
			...
			string(JSON _NBL_GEN_JSON_TOP_CONFIG_CONTENT_ ERROR_VARIABLE _NBL_JSON_ERROR_ REMOVE "${_NBL_JSON_TOP_CONFIG_CONTENT_}" profiles)
			...
			foreach(_NBL_IDX_ RANGE ${_NBL_STOP_})
				...
				file(GENERATE OUTPUT "${NBL_PROFILES_JSON_DIR}/${_NBL_IDX_}.json" CONTENT "${_NBL_GEN_PROFILE_JSON_TOP_CONFIG_CONTENT_CONFIGURED_}" CONDITION $<CONFIG:${_NBL_JSON_RUNCONFIGURATION_CONTENT_}>)
			endforeach()
		endif()
	endif()
endfunction()
