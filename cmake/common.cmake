...
set(NSC_SHADER_CACHE_COMPRESSION "raw" CACHE STRING "NSC shader cache compression (raw or lzma)")
...
option(NSC_JSON_REPORT "Write NSC JSON report alongside outputs" OFF)
...
@MEMBER_LINES@	};
	...
	if(IMPL_EXPORT_RULES)
		set(${IMPL_EXPORT_RULES}_COUNT "${_NBL_EXPORT_RULE_INDEX}" PARENT_SCOPE)
		if(_NBL_EXPORT_RULE_INDEX GREATER 0)
			math(EXPR _NBL_EXPORT_LAST "${_NBL_EXPORT_RULE_INDEX} - 1")
			foreach(_NBL_EXPORT_IDX RANGE 0 ${_NBL_EXPORT_LAST})
				set(${IMPL_EXPORT_RULES}_COMMAND_${_NBL_EXPORT_IDX} ${${IMPL_EXPORT_RULES}_COMMAND_${_NBL_EXPORT_IDX}} PARENT_SCOPE)
				set(${IMPL_EXPORT_RULES}_OUTPUT_${_NBL_EXPORT_IDX} "${${IMPL_EXPORT_RULES}_OUTPUT_${_NBL_EXPORT_IDX}}" PARENT_SCOPE)
				set(${IMPL_EXPORT_RULES}_LOG_${_NBL_EXPORT_IDX} "${${IMPL_EXPORT_RULES}_LOG_${_NBL_EXPORT_IDX}}" PARENT_SCOPE)
				set(${IMPL_EXPORT_RULES}_CACHE_SHADER_${_NBL_EXPORT_IDX} "${${IMPL_EXPORT_RULES}_CACHE_SHADER_${_NBL_EXPORT_IDX}}" PARENT_SCOPE)
				set(${IMPL_EXPORT_RULES}_CACHE_PREPROCESS_${_NBL_EXPORT_IDX} "${${IMPL_EXPORT_RULES}_CACHE_PREPROCESS_${_NBL_EXPORT_IDX}}" PARENT_SCOPE)
				set(${IMPL_EXPORT_RULES}_PREPROCESSED_${_NBL_EXPORT_IDX} "${${IMPL_EXPORT_RULES}_PREPROCESSED_${_NBL_EXPORT_IDX}}" PARENT_SCOPE)
				set(${IMPL_EXPORT_RULES}_DEPFILE_${_NBL_EXPORT_IDX} "${${IMPL_EXPORT_RULES}_DEPFILE_${_NBL_EXPORT_IDX}}" PARENT_SCOPE)
				set(${IMPL_EXPORT_RULES}_REPORT_${_NBL_EXPORT_IDX} "${${IMPL_EXPORT_RULES}_REPORT_${_NBL_EXPORT_IDX}}" PARENT_SCOPE)
			endforeach()
		endif()
	endif()
endfunction()
