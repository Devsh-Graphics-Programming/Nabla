...
function(nbl_adjust_flags)
	...
	if(NBL_TARGET)
		...
		while(_NBL_ARG_I_ LESS ${_NBL_V_OPTION_LEN_})		
			...
			get_target_property(_NBL_TARGET_MSVC_DEBUG_INFORMATION_FORMAT ${NBL_TARGET_ITEM} MSVC_DEBUG_INFORMATION_FORMAT)
			if(NOT _NBL_TARGET_MSVC_DEBUG_INFORMATION_FORMAT)
				set_target_properties(${NBL_TARGET_ITEM} PROPERTIES
			...
			unset(_NBL_TARGET_MSVC_DEBUG_INFORMATION_FORMAT)
