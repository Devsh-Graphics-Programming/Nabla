...
foreach(_NBL_EXAMPLE_RUNTIME_COMPONENT IN LISTS _NBL_EXAMPLE_RUNTIME_COMPONENTS)
	string(TOUPPER "${_NBL_EXAMPLE_RUNTIME_COMPONENT}" _NBL_EXAMPLE_RUNTIME_COMPONENT_UPPER)
	list(APPEND CPACK_COMPONENTS_ALL "${_NBL_EXAMPLE_RUNTIME_COMPONENT}")

	get_property(_NBL_EXAMPLE_RUNTIME_DISPLAY_NAME GLOBAL PROPERTY "NBL_EXAMPLE_RUNTIME_COMPONENT_${_NBL_EXAMPLE_RUNTIME_COMPONENT}_DISPLAY_NAME")
	if(_NBL_EXAMPLE_RUNTIME_DISPLAY_NAME)
		set(CPACK_COMPONENT_${_NBL_EXAMPLE_RUNTIME_COMPONENT_UPPER}_DISPLAY_NAME "${_NBL_EXAMPLE_RUNTIME_DISPLAY_NAME}")
	else()
		set(CPACK_COMPONENT_${_NBL_EXAMPLE_RUNTIME_COMPONENT_UPPER}_DISPLAY_NAME "${_NBL_EXAMPLE_RUNTIME_COMPONENT}")
	endif()

	get_property(_NBL_EXAMPLE_RUNTIME_DESCRIPTION GLOBAL PROPERTY "NBL_EXAMPLE_RUNTIME_COMPONENT_${_NBL_EXAMPLE_RUNTIME_COMPONENT}_DESCRIPTION")
	if(_NBL_EXAMPLE_RUNTIME_DESCRIPTION)
		set(CPACK_COMPONENT_${_NBL_EXAMPLE_RUNTIME_COMPONENT_UPPER}_DESCRIPTION "${_NBL_EXAMPLE_RUNTIME_DESCRIPTION}")
	endif()

	set(CPACK_COMPONENT_${_NBL_EXAMPLE_RUNTIME_COMPONENT_UPPER}_GROUP "executables")
endforeach()
