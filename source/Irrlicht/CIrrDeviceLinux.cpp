...
bool CIrrDeviceLinux::present(video::IImage* image, void* windowId, core::rect<int32_t>* srcRect)
{
	...
	video::E_FORMAT destColor;
	switch (SoftwareImage->bits_per_pixel)
	{
		case 16:
			if (SoftwareImage->depth==16)
				destColor = video::EF_R5G6B5;
			else
				destColor = video::EF_A1R5G5B5;
		break;
		case 24: destColor = video::EF_R8G8B8_UNORM; break;
		case 32: destColor = video::EF_B8G8R8A8_UNORM; break;
		default:
...
video::E_FORMAT CIrrDeviceLinux::getColorFormat() const
{
#ifdef _IRR_COMPILE_WITH_X11_
