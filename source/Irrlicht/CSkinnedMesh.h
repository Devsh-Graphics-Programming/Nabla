...
namespace scene
{
	...
	public:
		...
		virtual ICPUMesh* getMesh(s32 frame, s32 detailLevel=255);
		...
		virtual bool useAnimationFrom(const ICPUSkinnedMesh *mesh);
...
private:
		...
		core::array<SCPUSkinMeshBuffer*> *SkinningBuffers; //Meshbuffer to skin, default is to skin localBuffers
