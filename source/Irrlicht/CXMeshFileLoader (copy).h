...
private:
	...
	bool parseDataObjectFrame(CCPUSkinnedMesh::SJoint *parent);
	...
	core::array<CCPUSkinnedMesh::SJoint*> *AllJoints;
	...
	CCPUSkinnedMesh::SJoint *CurFrame;
