...
namespace impl
{
    ...
    static void convertColor_RTimpl(ECOLOR_FORMAT _dfmt, const void* _srcPix[4], void* _dstPix, uint64_t _scale, size_t _pixOrBlockCnt, core::vector3d<uint32_t>& _imgSize)
    {
        switch (_dfmt)
        {
