...
protected:
	...
	irr::core::stringw minTexfilterToString(video::E_TEXTURE_FILTER_TYPE etft) const;
	irr::core::stringw magTexfilterToString(video::E_TEXTURE_FILTER_TYPE etft) const;
