...
public:
	...
	static void getOpenGLFormatAndParametersFromColorFormat(const E_FORMAT &format, GLenum& colorformat, GLenum& type); //kill this

	static GLint getOpenGLFormatAndParametersFromColorFormat(const E_FORMAT &format);

	//!
	static E_FORMAT getColorFormatFromSizedOpenGLFormat(const GLenum& sizedFormat);
