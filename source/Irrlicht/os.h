...
namespace os
{
	...
	public:
		...
		static void reset(int32_t value=0x0f0f0f0f);
		...
		static int32_t randMax();

	private:

		static int32_t seed;
		static const int32_t m = 2147483399;	// a non-Mersenne prime
		static const int32_t a = 40692;			// another spectral success story
		static const int32_t q = m/a;
		static const int32_t r = m%a;			// again less than q
		static const int32_t rMax = m-1;
	};
