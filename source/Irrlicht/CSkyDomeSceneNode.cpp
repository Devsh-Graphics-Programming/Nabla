...
void CSkyDomeSceneNode::generateMesh()
{
    ...
    vao->setVertexAttrBuffer(vAttr,asset::EVAI_ATTR0,video::EF_R32G32B32_SFLOAT,4*(3+2),0);
    vao->setVertexAttrBuffer(vAttr,asset::EVAI_ATTR2,video::EF_R32G32_SFLOAT,4*(3+2),4*3);
    vAttr->drop();
