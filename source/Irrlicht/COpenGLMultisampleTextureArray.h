...
class COpenGLMultisampleTextureArray : public COpenGLTexture, public IMultisampleTexture, public IDriverMemoryAllocation
{
    ...
    public:
        ...
        //!
        virtual size_t getAllocationSize() const {return (TextureSize[2]*TextureSize[1]*TextureSize[0]*SampleCount*asset::getBytesPerPixel(ColorFormat)).getIntegerApprox();}
