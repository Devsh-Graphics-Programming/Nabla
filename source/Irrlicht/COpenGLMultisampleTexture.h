...
#ifndef __C_OPEN_GL_MULTISAMPLE_TEXTURE_H_INCLUDED__
...
class COpenGLMultisampleTexture : public COpenGLTexture, public IMultisampleTexture, public IDriverMemoryAllocation
{
    ...
    public:
        //! constructor
        COpenGLMultisampleTexture(GLenum internalFormat, const uint32_t& samples, const uint32_t* size, const bool& fixedSampleLocations);


        //! returns the opengl texture type
        virtual GLenum getOpenGLTextureType() const {return GL_TEXTURE_2D_MULTISAMPLE;}
