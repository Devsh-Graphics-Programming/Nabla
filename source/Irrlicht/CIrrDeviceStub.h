...
namespace irr
{
	...
	class CIrrDeviceStub : public IrrlichtDevice
	{
        ...
        public:
            ...
            asset::IIncludeHandler* getIncludeHandler() override { return IncludeHandler; }
            const asset::IIncludeHandler* getIncludeHandler() const override { return IncludeHandler; }
        ...
        protected:
            ...
            asset::IIncludeHandler* IncludeHandler;
