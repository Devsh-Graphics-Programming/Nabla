...
namespace video
{
COpenGLQuery::COpenGLQuery(const GLenum& type_in)
    : object(0), type(type_in), active(false), queryNeedsUpdate(false), queryIsReady(true), cachedCounter32(0), cachedCounter64(0)
{
