...
namespace instr_stream
{
	...
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_SHIFT_3RD_PARAM_TEX = INSTR_OPCODE_WIDTH + 8u;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_SHIFT_4TH_PARAM_TEX = INSTR_OPCODE_WIDTH + 4u;


	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_MASK_OPACITY_TEX = 0x1u;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_SHIFT_OPACITY_TEX = BITFIELDS_SHIFT_3RD_PARAM_TEX;

	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_MASK_REFL_TEX = 0x1u;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_SHIFT_REFL_TEX = BITFIELDS_SHIFT_4TH_PARAM_TEX;
	...
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_SHIFT_TRANS_TEX = BITFIELDS_SHIFT_1ST_PARAM_TEX;
	...
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_SHIFT_SIGMA_A_TEX = BITFIELDS_SHIFT_4TH_PARAM_TEX;
	...
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_MASK_TWOSIDED = 0x1u;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_SHIFT_TWOSIDED = INSTR_OPCODE_WIDTH + 6u;

	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_MASK_MASKFLAG = 0x1u;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_SHIFT_MASKFLAG = INSTR_OPCODE_WIDTH + 7u;
...
#define _TEXTURE_INDEX(s,m) offsetof(s,m)/sizeof(STextureOrConstant)
	...
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t OPACITY_TEX_IX = _TEXTURE_INDEX(SAllDiffuse, opacity);
...
#undef _TEXTURE_INDEX
	...
	{
		_NBL_STATIC_INLINE_CONSTEXPR size_t MAX_TEXTURES = 4ull;
...
{
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t INSTR_RIGHT_JUMP_WIDTH = 8u;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t INSTR_RIGHT_JUMP_MASK = 0xffu;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t INSTR_RIGHT_JUMP_SHIFT = BITFIELDS_BSDF_BUF_OFFSET_SHIFT + BITFIELDS_BSDF_BUF_OFFSET_WIDTH;
}
namespace tex_prefetch
{
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_FETCH_TEX_0_SHIFT = BITFIELDS_SHIFT_NDF;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_FETCH_TEX_1_SHIFT = BITFIELDS_SHIFT_NDF+1u;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_FETCH_TEX_2_SHIFT = BITFIELDS_SHIFT_TWOSIDED;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_FETCH_TEX_3_SHIFT = BITFIELDS_SHIFT_MASKFLAG;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_FETCH_TEX_COUNT = 4u;

	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_REG_WIDTH = 6u;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_REG_0_SHIFT = 32u;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_REG_1_SHIFT = BITFIELDS_REG_0_SHIFT + BITFIELDS_REG_WIDTH;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_REG_2_SHIFT = BITFIELDS_REG_1_SHIFT + BITFIELDS_REG_WIDTH;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_REG_3_SHIFT = BITFIELDS_REG_2_SHIFT + BITFIELDS_REG_WIDTH;

	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_FETCH_TEX_REG_CNT_WIDTH = 2u;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_FETCH_TEX_REG_CNT_MASK = 0b11;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_FETCH_TEX_0_REG_CNT_SHIFT = BITFIELDS_REG_3_SHIFT + BITFIELDS_REG_WIDTH;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_FETCH_TEX_1_REG_CNT_SHIFT = BITFIELDS_FETCH_TEX_0_REG_CNT_SHIFT + BITFIELDS_FETCH_TEX_REG_CNT_WIDTH;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_FETCH_TEX_2_REG_CNT_SHIFT = BITFIELDS_FETCH_TEX_1_REG_CNT_SHIFT + BITFIELDS_FETCH_TEX_REG_CNT_WIDTH;
	_NBL_STATIC_INLINE_CONSTEXPR uint32_t BITFIELDS_FETCH_TEX_3_REG_CNT_SHIFT = BITFIELDS_FETCH_TEX_2_REG_CNT_SHIFT + BITFIELDS_FETCH_TEX_REG_CNT_WIDTH;
