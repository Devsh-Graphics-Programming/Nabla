...
#ifndef __IRR_C_FLATTEN_REGIONS_IMAGE_FILTER_H_INCLUDED__
#define __IRR_C_FLATTEN_REGIONS_IMAGE_FILTER_H_INCLUDED__
	...
	public:
		...
		class CState : public IImageFilter::IState
		{
			public:
				...
				bool								preFill = true;			//!< state whether to fill values using fillValue if there is a pixel and any region doesn't cover it with
