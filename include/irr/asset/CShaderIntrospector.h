...
class CShaderIntrospector : public core::Uncopyable
{
	public:
        ...
        core::smart_refctd_dynamic_array<SPushConstantRange> createPushConstantRangesFromIntrospection(ICPUSpecializedShader* const* const begin, const ICPUSpecializedShader* const* const end, const std::string& entryPoint, const core::smart_refctd_dynamic_array<std::string>& _extensions);
        core::smart_refctd_ptr<ICPUDescriptorSetLayout> createApproximateDescriptorSetLayoutFromIntrospection(uint32_t set, ICPUSpecializedShader* const* const begin, const ICPUSpecializedShader* const* const end, const std::string& entryPoint, const core::smart_refctd_dynamic_array<std::string>& _extensions);
        core::smart_refctd_ptr<ICPUPipelineLayout> createApproximatePipelineLayoutFromIntrospection(ICPUSpecializedShader* const* const begin, const ICPUSpecializedShader* const* const end, const std::string& entryPoint, const core::smart_refctd_dynamic_array<std::string>& _extensions);
	private:
