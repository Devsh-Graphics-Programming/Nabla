...
#include <irr/builtin/glsl/workgroup/shared_shuffle_relative.glsl>
		...
		#define _IRR_GLSL_SCRATCH_SHARED_SIZE_DEFINED_ _IRR_GLSL_WORKGROUP_SHUFFLE_RELATIVE_SHARED_SIZE_NEEDED_
