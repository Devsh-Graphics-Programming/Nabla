...
vec3 irr_glsl_ashikhmin_shirley_cos_eval(in irr_glsl_BSDFAnisotropicParams params, in irr_glsl_AnisotropicViewSurfaceInteraction inter, in vec2 n, in vec2 sin_cos_phi, in vec2 atb, in mat2x3 ior2)
{
