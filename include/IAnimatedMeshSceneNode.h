...
#ifdef NEW_MESHES
		//! Sets a new mesh
		virtual void setMesh(ICPUAnimatedMesh* mesh) = 0;

		//! Returns the current mesh
		virtual ICPUAnimatedMesh* getMesh(void) = 0;
#else
		//! Sets a new mesh
		virtual void setMesh(IGPUAnimatedMesh* mesh) = 0;

		//! Returns the current mesh
		virtual IGPUAnimatedMesh* getMesh(void) = 0;
#endif // NEW_MESHES
