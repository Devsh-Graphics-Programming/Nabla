...
public:
    ...
    CGraphicalApplicationAndroid(android_app* app,
        ...
        : system::CApplicationAndroid(app, env, _localInputCWD, _localOutputCWD, _sharedInputCWD, _sharedOutputCWD) {}
...
#define NBL_ANDROID_MAIN_FUNC(android_app_class, window_event_callback, ...)                                           \
