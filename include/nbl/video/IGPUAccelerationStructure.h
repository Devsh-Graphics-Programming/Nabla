...
public:
    ...
    struct BuildGeometryInfo
    {
        ...
        BuildGeometryInfo()
            : type(static_cast<Base::E_TYPE>(0u)), buildFlags(static_cast<E_BUILD_FLAGS>(0u)), buildMode(static_cast<E_BUILD_MODE>(0u)), srcAS(nullptr), dstAS(nullptr), geometries(core::SRange<Geometry>(nullptr, nullptr)), scratchAddr({})
        {}
