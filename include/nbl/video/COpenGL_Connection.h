...
class NBL_API2 COpenGL_Connection final : public IAPIConnection
{
    ...
    private:
        inline COpenGL_Connection(const SFeatures& enabledFeatures, core::smart_refctd_ptr<asset::IGLSLCompiler>&& glslc) : IAPIConnection(enabledFeatures, std::move(glslc))
        {}
};
