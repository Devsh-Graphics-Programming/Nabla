...
public:
    struct FloatOrTexture
    {
        ...
        FloatOrTexture(const SPropertyElementData& _other)
            : FloatOrTexture(nullptr)
        {
            operator=(_other);
        }
        FloatOrTexture(SPropertyElementData&& _other)
            : FloatOrTexture(nullptr)
        {
    ...
    {
        SpectrumOrTexture(CElementTexture* _tex)
            : FloatOrTexture(_tex) {}
        SpectrumOrTexture(float _value)
            : FloatOrTexture(_value) {}
        SpectrumOrTexture(const SPropertyElementData& _other)
            : SpectrumOrTexture(nullptr)
        {
            operator=(_other);
        }
        SpectrumOrTexture(SPropertyElementData&& _other)
            : SpectrumOrTexture(nullptr)
        {
            operator=(std::move(_other));
        }
    ...
    CElementTexture(const char* id)
        : IElement(id), type(Type::INVALID)
    {
    }
    CElementTexture(const CElementTexture& other)
        : CElementTexture("")
    {
        operator=(other);
    }
    CElementTexture(CElementTexture&& other)
        : CElementTexture("")
    {
