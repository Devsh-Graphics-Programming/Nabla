...
struct SPropertyElementData
{
    ...
    inline SPropertyElementData(const SPropertyElementData& other)
        : SPropertyElementData()
    {
        operator=(other);
    }
    inline SPropertyElementData(SPropertyElementData&& other)
        : SPropertyElementData()
    {
        operator=(std::move(other));
    }
    inline SPropertyElementData(const std::string& _type)
        : SPropertyElementData()
    {
    ...
    inline explicit SPropertyElementData(float value)
        : type(FLOAT) { fvalue = value; }
    inline explicit SPropertyElementData(int32_t value)
        : type(INTEGER) { ivalue = value; }
    inline explicit SPropertyElementData(bool value)
        : type(BOOLEAN) { bvalue = value; }
    //explicit SPropertyElementData(const std::string& value)						: type(STRING) { #error }
    inline explicit SPropertyElementData(Type _type, const core::vectorSIMDf& value)
        : type(INVALID)
    {
        switch(_type)
        {
...
struct SNamedPropertyElement : SPropertyElementData
{
    SNamedPropertyElement()
        : SPropertyElementData(), name("")
    {
    }
    SNamedPropertyElement(const std::string& _type)
        : SNamedPropertyElement()
    {
    ...
    SNamedPropertyElement(const SNamedPropertyElement& other)
        : SNamedPropertyElement()
    {
        SNamedPropertyElement::operator=(other);
    }
    SNamedPropertyElement(SNamedPropertyElement&& other)
        : SNamedPropertyElement()
    {
...
template<>
struct SPropertyElementData::get_typename<SPropertyElementData::Type::FLOAT>
{
    using type = float;
};
template<>
struct SPropertyElementData::get_typename<SPropertyElementData::Type::INTEGER>
{
    using type = int32_t;
};
template<>
struct SPropertyElementData::get_typename<SPropertyElementData::Type::BOOLEAN>
{
    using type = bool;
};
template<>
struct SPropertyElementData::get_typename<SPropertyElementData::Type::STRING>
{
    using type = const char*;
};
template<>
struct SPropertyElementData::get_typename<SPropertyElementData::Type::RGB>
{
    using type = core::vectorSIMDf;
};
template<>
struct SPropertyElementData::get_typename<SPropertyElementData::Type::SRGB>
{
    using type = core::vectorSIMDf;
};
template<>
struct SPropertyElementData::get_typename<SPropertyElementData::Type::VECTOR>
{
    using type = core::vectorSIMDf;
};
template<>
struct SPropertyElementData::get_typename<SPropertyElementData::Type::POINT>
{
    using type = core::vectorSIMDf;
};
template<>
struct SPropertyElementData::get_typename<SPropertyElementData::Type::SPECTRUM>
{
    using type = core::vectorSIMDf;
};
template<>
struct SPropertyElementData::get_typename<SPropertyElementData::Type::BLACKBODY>
{
    using type = void;
};
template<>
struct SPropertyElementData::get_typename<SPropertyElementData::Type::MATRIX>
{
    using type = core::matrix4SIMD;
};
template<>
struct SPropertyElementData::get_typename<SPropertyElementData::Type::TRANSLATE>
{
    using type = core::matrix4SIMD;
};
template<>
struct SPropertyElementData::get_typename<SPropertyElementData::Type::ROTATE>
{
    using type = core::matrix4SIMD;
};
template<>
struct SPropertyElementData::get_typename<SPropertyElementData::Type::SCALE>
{
    using type = core::matrix4SIMD;
};
template<>
struct SPropertyElementData::get_typename<SPropertyElementData::Type::LOOKAT>
{
    using type = core::matrix4SIMD;
};
template<>
struct SPropertyElementData::get_typename<SPropertyElementData::Type::INVALID>
{
    using type = void;
};
