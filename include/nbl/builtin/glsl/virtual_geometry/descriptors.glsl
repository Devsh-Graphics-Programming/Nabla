...
#endif
#if (_NBL_VG_USE_SSBO_UVEC4 && !_NBL_VG_SSBO_UVEC4_BINDING)
#define _NBL_VG_SSBO_UVEC4_BINDING 0
#endif
#if (_NBL_VG_USE_SSBO_UVEC3 && !_NBL_VG_SSBO_UVEC3_BINDING)
#define _NBL_VG_SSBO_UVEC3_BINDING 1
#endif
#if (_NBL_VG_USE_SSBO_UVEC2 && !_NBL_VG_SSBO_UVEC2_BINDING)
#define _NBL_VG_SSBO_UVEC2_BINDING 2
#endif
#if (_NBL_VG_USE_SSBO_UINT && !_NBL_VG_SSBO_UINT_BINDING)
