...
// TODO: detect compute shader stage, provide nbl_glsl_NumSubgroups and nbl_glsl_SubgroupID
	...
	#define nbl_glsl_SubgroupEqMask (0x1<<gl_LocalInvocationIndex)
	#define nbl_glsl_SubgroupGeMask (0xffffffff<<gl_LocalInvocationIndex)
...
#define nbl_glsl_HalfSubgroupSize (gl_SubgroupSize>>0x1)
...
/* TODO: Do we provide a min and max elect? (because sometimes we cannot be sure of subgroup size)
