...
#define NBL_GLSL_CONCATENATE2(X,Y) NBL_GLSL_EVAL(X) ## NBL_GLSL_EVAL(Y)
#define NBL_GLSL_CONCATENATE3(X,Y,Z) NBL_GLSL_CONCATENATE2(X,Y) ## NBL_GLSL_EVAL(Z)
#define NBL_GLSL_CONCATENATE4(X,Y,Z,W) NBL_GLSL_CONCATENATE3(X,Y,Z) ## NBL_GLSL_EVAL(W)
