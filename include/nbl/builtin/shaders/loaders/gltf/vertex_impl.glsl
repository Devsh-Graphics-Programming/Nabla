#include "nbl/builtin/shaders/loaders/gltf/common.glsl"
...
layout(location = _NBL_V_IN_COLOR_ATTRIBUTE_BEGINING_ID) in vec4 vColor_0;
#ifdef _NBL_EXTRA_V_IN_COLOR_ATTRIBUTE_ID_1_ENABLE
#define _NBL_EXTRA_V_IN_COLOR_ATTRIBUTE_ID_1 _NBL_V_IN_COLOR_ATTRIBUTE_BEGINING_ID + 1
layout(location = _NBL_EXTRA_V_IN_COLOR_ATTRIBUTE_ID_1) in vec4 vColor_1
#endif // _NBL_EXTRA_V_IN_COLOR_ATTRIBUTE_ID_1_ENABLE
#ifdef _NBL_EXTRA_V_IN_COLOR_ATTRIBUTE_ID_2_ENABLE
#define _NBL_EXTRA_V_IN_COLOR_ATTRIBUTE_ID_2 _NBL_V_IN_COLOR_ATTRIBUTE_BEGINING_ID + 2
layout(location = _NBL_EXTRA_V_IN_COLOR_ATTRIBUTE_ID_2) in vec4 vColor_2
#endif // _NBL_EXTRA_V_IN_COLOR_ATTRIBUTE_ID_2_ENABLE
#endif // _DISABLE_COLOR_ATTRIBUTES

#ifndef _DISABLE_UV_ATTRIBUTES
layout (location = _NBL_V_IN_UV_ATTRIBUTE_BEGINING_ID) in vec2 vUV_0;
#ifdef _NBL_EXTRA_V_IN_UV_ATTRIBUTE_ID_1_ENABLE
#define _NBL_EXTRA_V_IN_UV_ATTRIBUTE_ID_1 _NBL_V_IN_UV_ATTRIBUTE_BEGINING_ID + 1
layout (location = _NBL_EXTRA_V_IN_UV_ATTRIBUTE_ID_1) in vec2 vUV_1
#endif // _NBL_EXTRA_V_IN_UV_ATTRIBUTE_ID_1_ENABLE
#ifdef _NBL_EXTRA_V_IN_UV_ATTRIBUTE_ID_2_ENABLE
#define _NBL_EXTRA_V_IN_UV_ATTRIBUTE_ID_2 _NBL_V_IN_UV_ATTRIBUTE_BEGINING_ID + 2
layout(location = _NBL_EXTRA_V_IN_UV_ATTRIBUTE_ID_2) in vec2 vUV_2
#endif // _NBL_EXTRA_V_IN_UV_ATTRIBUTE_ID_2_ENABLE
