...
// -----------------------------------------------------------------------------------------------------------------------------------------------------------------
template<uint16_t LowChannel, uint16_t HighChannel, bool Inverse, typename Scalar, class device_capabilities=void>
struct FFT
{
    template <typename InvocationElementsAccessor>
    static void __call(NBL_REF_ARG(InvocationElementsAccessor) loAccessor, NBL_REF_ARG(InvocationElementsAccessor) hiAccessor);
};

// ---------------------------------------- Radix 2 forward transform - DIF -------------------------------------------------------

template<uint16_t LowChannel, uint16_t HighChannel, typename Scalar, class device_capabilities>
struct FFT<LowChannel, HighChannel, false, Scalar, device_capabilities>
{
