...
namespace shapes
{
    ...
    float32_t2 SolveQuadratic(float32_t3 c, NBL_REF_ARG(int32_t) numRealValues)
    {
    ...
    struct CubicBezier
    {
        ...
        void sort_roots3(NBL_REF_ARG(float32_t3) roots){
            float32_t3 tmp;
        ...
        void sort_roots4(NBL_REF_ARG(float32_t4) roots){
            float32_t4 tmp;
        ...
        // Modified from http://tog.acm.org/resources/GraphicsGems/gems/Roots3And4.c
        // Credits to Doublefresh for hinting there
        int32_t solve_quadric(float32_t2 coeffs, NBL_REF_ARG(float32_t2) roots)
        {
        ...
        int32_t solve_cubic(float32_t3 coeffs, NBL_REF_ARG(float32_t3) r)
        {
        ...
        // Modified from http://tog.acm.org/resources/GraphicsGems/gems/Roots3And4.c
        // Credits to Doublefresh for hinting there
        int32_t solve_quartic(float32_t4 coeffs, NBL_REF_ARG(float32_t4) s)
        {
