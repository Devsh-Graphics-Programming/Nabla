...
template<typename T>
T identity(typename NBL_CONST_REF_ARG(T) nonlinear)
{
    return nonlinear;
}

template<typename T>
T impl_shared_2_4(typename NBL_CONST_REF_ARG(T) nonlinear, typename ValueType<T>::type vertex)
{
...
template<typename T>
T sRGB(typename NBL_CONST_REF_ARG(T) nonlinear)
{
    using Val_t = ValueType<T>::type;
...
template<typename T>
T Display_P3(typename NBL_CONST_REF_ARG(T) nonlinear)
{
    using Val_t = ValueType<T>::type;
...
template<typename T>
T DCI_P3_XYZ(typename NBL_CONST_REF_ARG(T) nonlinear)
{
    using Val_t = ValueType<T>::type;
...
template<typename T>
T SMPTE_170M(typename NBL_CONST_REF_ARG(T) nonlinear)
{
    using Val_t = ValueType<T>::type;
...
template<typename T>
T SMPTE_ST2084(typename NBL_CONST_REF_ARG(T) nonlinear)
{
    using Val_t = ValueType<T>::type;
...
template<typename T>
T HDR10_HLG(typename NBL_CONST_REF_ARG(T) nonlinear)
{
    using Val_t = ValueType<T>::type;
...
template<typename T>
T AdobeRGB(typename NBL_CONST_REF_ARG(T) nonlinear)
{
    using Val_t = ValueType<T>::type;
...
template<typename T>
T Gamma_2_2(typename NBL_CONST_REF_ARG(T) nonlinear)
{
    using Val_t = ValueType<T>::type;
...
template<typename T>
T ACEScc(typename NBL_CONST_REF_ARG(T) nonlinear)
{
    using Val_t = ValueType<T>::type;
...
template<typename T>
T ACEScct(typename NBL_CONST_REF_ARG(T) nonlinear)
{
    using Val_t = ValueType<T>::type;
