...
NBL_CONSTEXPR float3x3 XYZtoscRGB = float3x3(   float3( 3.2404542, -1.5371385, -0.4985314),
...
NBL_CONSTEXPR float3x3 XYZtoDisplay_P3 = float3x3(  float3( 2.4934969, -0.9313836, -0.4027108),
...
NBL_CONSTEXPR float3x3 XYZtoBT2020 = float3x3(  float3( 1.7166512, -0.3556708, -0.2533663),
...
NBL_CONSTEXPR float3x3 XYZtoAdobeRGB = float3x3(    float3( 2.04159, -0.56501, -0.34473),
                                            float3(-0.96924,  1.87597, -0.04156),
                                            float3( 0.01344, -0.11836,  1.01517));


NBL_CONSTEXPR float3x3 XYZtoACES2065_1 = float3x3(  float3( 1.0498110175, -0.4959030231,  0.0000000000),
                                            float3( 0.0000000000,  1.3733130458,  0.0000000000),
                                            float3(-0.0000974845,  0.0982400361,  0.9912520182));


NBL_CONSTEXPR float3x3 XYZtoACEScc = float3x3(  float3( 1.6410234, -0.3248033, -0.2364247),
