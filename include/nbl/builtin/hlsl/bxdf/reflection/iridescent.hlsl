...
using SIridescent = SCookTorrance<Config, ndf::GGX<typename Config::sample_type::scalar_type, false, ndf::MTT_REFLECT>, fresnel::Iridescent<typename Config::spectral_type, false, colorspace::scRGB> >;
