...
{
	const typename vector_traits<T>::scalar_type a = typename vector_traits<T>::scalar_type(NBL_FP64_LITERAL(1.0)) / (typename vector_traits<T>::scalar_type(NBL_FP64_LITERAL(1.0)) + normal.z);
