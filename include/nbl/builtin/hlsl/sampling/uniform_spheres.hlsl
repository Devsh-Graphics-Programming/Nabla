...
namespace nbl
{
    namespace hlsl
    {
        namespace sampling
        {
            ...
            template <typename T NBL_PRIMARY_REQUIRES(is_scalar_v<T>) struct UniformHemisphere
            {
            ...
            template <typename T NBL_PRIMARY_REQUIRES(is_scalar_v<T>) struct UniformSphere
            {
                using vector_t2 = vector<T, 2>;
                using vector_t3 = vector<T, 3>;
