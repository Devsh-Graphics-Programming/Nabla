...
struct is_any_of_values<cf, cmp> : std::false_type
{
};  //if last comparison is also false, than return false
...
template<typename T>
struct is_pointer_to_const_object : std::bool_constant<
                                        std::is_const_v<
