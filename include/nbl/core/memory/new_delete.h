...
struct AlignedWithAllocator
{
    ...
    {
        VA_ARGS_comma_workaround(size_t align, Alloc _alloc = Alloc())
            : m_align(align), m_alloc(_alloc) {}
...
#define _NBL_NEW_W_ALLOCATOR(_obj_type, _allocator, ...)                                                                                                                                      \
    nbl::core::impl::AlignedWithAllocator<_obj_type, _NBL_DEFAULT_ALLOCATOR_METATYPE<_obj_type> >::VA_ARGS_comma_workaround(_NBL_DEFAULT_ALIGNMENT(_obj_type), _allocator).new_(__VA_ARGS__); \
    _NBL_ASSERT_ALLOCATOR_VALUE_TYPE(_obj_type, decltype(_allocator))
#define _NBL_DELETE_W_ALLOCATOR(_obj, _allocator)                                                                                                                                                                                                                                           \
    nbl::core::impl::AlignedWithAllocator<typename std::remove_reference<typename std::remove_pointer<decltype(_obj)>::type>::type, _NBL_DEFAULT_ALLOCATOR_METATYPE<typename std::remove_reference<typename std::remove_pointer<decltype(_obj)>::type>::type> >::delete_(_obj, _allocator); \
...
#define _NBL_NEW_ARRAY_W_ALLOCATOR(_obj_type, count, _allocator)                                                                                                    \
    nbl::core::impl::AlignedWithAllocator<_obj_type, _NBL_DEFAULT_ALLOCATOR_METATYPE<_obj_type> >::new_array(count, _NBL_DEFAULT_ALIGNMENT(_obj_type), _allocator); \
    _NBL_ASSERT_ALLOCATOR_VALUE_TYPE(_obj_type, decltype(_allocator))
#define _NBL_DELETE_ARRAY_W_ALLOCATOR(_obj, count, _allocator)                                                                                                                                                                                                                                          \
    nbl::core::impl::AlignedWithAllocator<typename std::remove_reference<typename std::remove_pointer<decltype(_obj)>::type>::type, _NBL_DEFAULT_ALLOCATOR_METATYPE<typename std::remove_reference<typename std::remove_pointer<decltype(_obj)>::type>::type> >::delete_array(_obj, count, _allocator); \
    _NBL_ASSERT_ALLOCATOR_VALUE_TYPE(std::remove_reference<typename std::remove_pointer<decltype(_obj)>::type>::type, decltype(_allocator))
