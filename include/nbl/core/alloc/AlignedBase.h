...
{
private:
    struct DummyForConditional
    {
        typedef uint8_t most_aligned_type;
    };
...
private:
    ...
    template<class U>
    using operator_new_t = decltype(NBL_TYPENAME_4_STTC_MBR U::operator new(0ull));
    template<class U>
    using operator_new_array_t = decltype(NBL_TYPENAME_4_STTC_MBR U::operator new[](0ull));
    template<class U>
    using operator_placement_new_t = decltype(NBL_TYPENAME_4_STTC_MBR U::operator new(0ull, nullptr));
    template<class U>
    using operator_placement_new_array_t = decltype(NBL_TYPENAME_4_STTC_MBR U::operator new[](0ull, nullptr));
    template<class U>
    using operator_delete_t = decltype(NBL_TYPENAME_4_STTC_MBR U::operator delete(nullptr));
    template<class U>
    using operator_delete_array_t = decltype(NBL_TYPENAME_4_STTC_MBR U::operator delete[](nullptr));
    template<class U>
    using operator_delete_w_size_t = decltype(NBL_TYPENAME_4_STTC_MBR U::operator delete(nullptr, 0ull));
    template<class U>
    using operator_delete_array_w_size_t = decltype(NBL_TYPENAME_4_STTC_MBR U::operator delete[](nullptr, 0ull));

    template<class, class = void>
    struct has_new_operator : std::false_type
    {
    };
    template<class, class = void>
    struct has_new_array_operator : std::false_type
    {
    };
    template<class, class = void>
    struct has_placement_new_operator : std::false_type
    {
    };
    template<class, class = void>
    struct has_placement_new_array_operator : std::false_type
    {
    };
    template<class, class = void>
    struct has_delete_operator : std::false_type
    {
    };
    template<class, class = void>
    struct has_delete_array_operator : std::false_type
    {
    };
    template<class, class = void>
    struct has_delete_operator_w_size : std::false_type
    {
    };
    template<class, class = void>
    struct has_delete_array_operator_w_size : std::false_type
    {
    };
    template<class U>
    struct has_new_operator<U, std::void_t<operator_new_t<U> > > : std::is_same<operator_new_t<U>, void*>
    {
    };
    template<class U>
    struct has_new_array_operator<U, std::void_t<operator_new_array_t<U> > > : std::is_same<operator_new_array_t<U>, void*>
    {
    };
    template<class U>
    struct has_placement_new_operator<U, std::void_t<operator_placement_new_t<U> > > : std::is_same<operator_placement_new_t<U>, void*>
    {
    };
    template<class U>
    struct has_placement_new_array_operator<U, std::void_t<operator_placement_new_array_t<U> > > : std::is_same<operator_placement_new_array_t<U>, void*>
    {
    };
    template<class U>
    struct has_delete_operator<U, std::void_t<operator_delete_t<U> > > : std::is_same<operator_delete_t<U>, void>
    {
    };
    template<class U>
    struct has_delete_array_operator<U, std::void_t<operator_delete_array_t<U> > > : std::is_same<operator_delete_array_t<U>, void>
    {
    };
    template<class U>
    struct has_delete_operator_w_size<U, std::void_t<operator_delete_w_size_t<U> > > : std::is_same<operator_delete_w_size_t<U>, void>
    {
    };
    template<class U>
    struct has_delete_array_operator_w_size<U, std::void_t<operator_delete_array_w_size_t<U> > > : std::is_same<operator_delete_array_w_size_t<U>, void>
    {
    };
