...
template<>
NBL_FORCE_INLINE uint16_t nan<uint16_t>()
{
    return impl::NAN_U16;
}

template<>
NBL_FORCE_INLINE float nan<float>()
{
    return reinterpret_cast<const float&>(impl::NAN_U32);
}

template<>
NBL_FORCE_INLINE double nan<double>()
{
    return reinterpret_cast<const double&>(impl::NAN_U64);
}
...
template<>
NBL_FORCE_INLINE float infinity<float>()
{
    return reinterpret_cast<const float&>(impl::INFINITY_U32);
}
