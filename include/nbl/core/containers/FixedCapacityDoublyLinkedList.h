...
// Deprecated file, use DoublyLinkedList instead
...
class [[deprecated]] FixedCapacityDoublyLinkedListBase
{
public:
...
class [[deprecated]] FixedCapacityDoublyLinkedList : private impl::FixedCapacityDoublyLinkedListBase
{
public:
