...
class NBL_API NBL_FORCE_EBO NBL_NO_VTABLE Uncopyable
{
    public:
        Uncopyable() = default;
...
class NBL_API NBL_FORCE_EBO NBL_NO_VTABLE Interface : public Uncopyable
{
...
class NBL_API NBL_FORCE_EBO NBL_NO_VTABLE Unmovable
{
    public:
        Unmovable() = default;
...
class NBL_API NBL_FORCE_EBO NBL_NO_VTABLE InterfaceUnmovable : public Interface, public Unmovable
{
...
class NBL_API NBL_FORCE_EBO NBL_NO_VTABLE TotalInterface : public Interface
{
...
class NBL_API NBL_FORCE_EBO NBL_NO_VTABLE TotalInterfaceUnmovable : public TotalInterface, public Unmovable
{
