...
public:
    ...
    {
        Geometry()
            : type(static_cast<E_GEOM_TYPE>(0u)), flags(static_cast<E_GEOM_FLAGS>(0u)){};
        E_GEOM_TYPE type;
    ...
    {
        Instance()
            : instanceCustomIndex(0u), mask(0xFF), instanceShaderBindingTableRecordOffset(0u), flags(EIF_NONE), accelerationStructureReference(0ull), mat(core::matrix3x4SIMD())
        {}
