...
public:
    CFloatingPointSeparableImageFilterKernelBase(float _negative_support, float _positive_support)
        : StaticPolymorphicBase({_negative_support, _negative_support, _negative_support}, {_positive_support, _positive_support, _positive_support}) {}
...
public:
    CFloatingPointIsotropicSeparableImageFilterKernelBase()
        : Base(isotropic_support, isotropic_support) {}
