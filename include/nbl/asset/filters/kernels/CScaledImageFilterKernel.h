...
public:
    ...
    // constructor
    CScaledImageFilterKernelBase(const core::vectorSIMDf& _rscale, Kernel&& k)
        : kernel(std::move(k)), rscale(_rscale.x, _rscale.y, _rscale.z, 1.f), userData(_rscale.x * _rscale.y * _rscale.z) {}
...
class CScaledImageFilterKernel :  //order of bases is important! do not change
                                  public impl::CScaledImageFilterKernelBase<Kernel>,
                                  public CImageFilterKernel<CScaledImageFilterKernel<Kernel>, typename impl::CScaledImageFilterKernelBase<Kernel>::value_type>
{
...
public:
    ...
    CScaledImageFilterKernel(const core::vectorSIMDf& _scale, Kernel&& k = Kernel())
        : Base(core::vectorSIMDf(1.f).preciseDivision(_scale), std::move(k)),
    ...
    CScaledImageFilterKernel(const core::vectorSIMDf& _scale, const Kernel& k = Kernel())
        : CScaledImageFilterKernel(_scale, Kernel(k)) {}
