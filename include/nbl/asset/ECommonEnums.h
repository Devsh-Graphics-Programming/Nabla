...
//    MESH_SHADER_BIT = 0x1<<17,
    ...
    FRAGMENT_SHADING_RATE_ATTACHMENT_BIT = 0x1<<19,
...
//    OPTICAL_FLOW_WRITE_BIT=0x1u<<31,
    // special
    SHADER_READ_BITS = UNIFORM_READ_BIT|SAMPLED_READ_BIT|STORAGE_READ_BIT|INPUT_ATTACHMENT_READ_BIT|SHADER_BINDING_TABLE_READ_BIT,
    ...
    MEMORY_READ_BITS = HOST_READ_BIT|TRANSFER_READ_BIT/*|MICROMAP_READ_BIT*/|ACCELERATION_STRUCTURE_READ_BIT|COMMAND_PREPROCESS_READ_BIT|
        ...
        DENSITY_MAP_READ_BIT|SHADING_RATE_ATTACHMENT_READ_BIT|INPUT_ATTACHMENT_READ_BIT|DEPTH_STENCIL_ATTACHMENT_READ_BIT|COLOR_ATTACHMENT_READ_BIT|
