...
public:
    ...
    */
    ...
    virtual bool resetQueryPool(video::IQueryPool* queryPool, uint32_t firstQuery, uint32_t queryCount) {return false;} // TODO(achal): Do we really need a default implementation here?
