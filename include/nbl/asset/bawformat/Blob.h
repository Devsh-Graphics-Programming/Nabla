...
#include "nbl/nblpack.h"
	struct NBL_API NBL_FORCE_EBO Blob
	{
	...
	struct NBL_API NBL_FORCE_EBO SizedBlob
	{
	...
	struct NBL_API NBL_FORCE_EBO VariableSizeBlob : SizedBlob<VariableSizeBlob, B, T>
	{
	protected: // not intended for direct usage
		VariableSizeBlob() {}
		~VariableSizeBlob() {}
	...
	template<typename B, typename T>
	struct NBL_API NBL_FORCE_EBO FixedSizeBlob : SizedBlob<FixedSizeBlob, B, T>
	{
	protected: // not intended for direct usage
		FixedSizeBlob() {}
		~FixedSizeBlob() {}
	...
	template<typename B, typename T>
	struct NBL_API NBL_FORCE_EBO TypedBlob : Blob
	{
...
#include "nbl/nblunpack.h"
	...
	template<typename>
	struct NBL_API CorrespondingBlobTypeFor;
