...
class NBL_API2 IShaderCompiler : public core::IReferenceCounted
{
	public:
		...
		{
		public:
			virtual bool getInclude(const system::path& searchPath, const std::string& includeName, std::string& contents) const = 0;
		};
		...
		public:
			...
			virtual bool getInclude(const std::string& includeName, std::string& contents) const;
		...
		public:
			...
			bool getInclude(const system::path& searchPath, const std::string& includeName, std::string& contents) const override;
		...
		public:
			...
			bool getIncludeStandard(const system::path& requestingSourceDir, const std::string& includeName, std::string& contents) const;

			// ! includes within ""
			// @param requestingSourceDir: the directory where the incude was requested
			// @param includeName: the string within "" of the include preprocessing directive
			bool getIncludeRelative(const system::path& requestingSourceDir, const std::string& includeName, std::string& contents) const;
		...
		protected:
			...
			bool trySearchPaths(const std::string& includeName, std::string& contents) const;

			bool tryIncludeGenerators(const std::string& includeName, std::string& contents) const;
