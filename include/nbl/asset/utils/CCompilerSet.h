...
class NBL_API2 CCompilerSet : public core::IReferenceCounted
{
	public:
		...
		core::smart_refctd_ptr<IShader> compileToSPIRV(const asset::IShader* shader, const IShaderCompiler::SCompilerOptions& options) const;

		core::smart_refctd_ptr<IShader> preprocessShader(const asset::IShader* shader, hlsl::ShaderStage& stage, const IShaderCompiler::SPreprocessorOptions& preprocessOptions) const;
