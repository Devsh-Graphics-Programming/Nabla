...
public:
	...
	inline native_handle_t getNativeHandle() { return m_native; }
...
private:
    CWindowWin32(uint32_t _w, uint32_t _h, E_CREATE_FLAGS _flags) : IWindow(_w, _h, _flags), m_native(NULL)
    {
		// get process handle
		...
		wcex.lpfnWndProc = WndProc; // TODO this callback
		wcex.cbClsExtra = 0;
		wcex.cbWndExtra = 0;
