...
#ifndef __NBL_I_SCENE_NODE_ANIMATOR_CAMERA_MODIFIED_MAYA_H_INCLUDED__
#define __NBL_I_SCENE_NODE_ANIMATOR_CAMERA_MODIFIED_MAYA_H_INCLUDED__
...
public:
    ...
    virtual void toggleZoomWithRightButton() = 0;
