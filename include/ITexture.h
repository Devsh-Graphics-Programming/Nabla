...
class ITexture : public IRenderableVirtualTexture, public IDriverMemoryBacked
{
    public:
        ...
        //!
        virtual bool updateSubRegion(const E_FORMAT &inDataColorFormat, const void* data, const uint32_t* minimum, const uint32_t* maximum, int32_t mipmap=0, const uint32_t& unpackRowByteAlignment=0) = 0;
