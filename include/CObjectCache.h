...
struct NBL_FORCE_EBO NBL_NO_VTABLE PropagKeyTypeTypedef_
{
    using KeyType = K;
};
template<typename... K>
...
struct NBL_FORCE_EBO NBL_NO_VTABLE PropagTypedefs : PropagKeyTypeTypedef<K...>
{
    using CachedType = T;
};
...
public:
    ...
    inline explicit CObjectCacheBase(const GreetFuncType& _greeting, const DisposalFuncType& _disposal)
        : m_greetingFunc(_greeting), m_disposalFunc(_disposal) {}
    inline explicit CObjectCacheBase(GreetFuncType&& _greeting, DisposalFuncType&& _disposal)
        : m_greetingFunc(std::move(_greeting)), m_disposalFunc(std::move(_disposal)) {}
...
template<
    ...
    typename... K  //optionally key type for std::map/std::unordered_map
    >
struct NBL_FORCE_EBO CDirectCacheBase : public std::conditional<forMultiCache, CMultiObjectCacheBaseExt<isVectorContainer, ContainerT_T, Alloc, T, K...>, CUniqObjectCacheBaseExt<isVectorContainer, ContainerT_T, Alloc, T, K...>>::type
{
private:
...
struct key_val_pair_type_for
{
    using type = std::pair<const K, V>;
};

template<typename K, typename V>
struct key_val_pair_type_for<std::vector, K, V>
{
...
template<
    ...
    template<typename...> class ContainerT_T,
    typename Alloc>
class NBL_FORCE_EBO CMultiObjectCache<K, T, ContainerT_T, Alloc, true> : public impl::CDirectMultiCacheBase<true, ContainerT_T, Alloc, std::pair<K, T>>,
...
template<
    ...
    template<typename...> class ContainerT_T,
    typename Alloc>
class NBL_FORCE_EBO CMultiObjectCache<K, T, ContainerT_T, Alloc, false> : public impl::CDirectMultiCacheBase<false, ContainerT_T, Alloc, T, const K>,
...
template<
    ...
    template<typename...> class ContainerT_T,
    typename Alloc>
class NBL_FORCE_EBO CObjectCache<K, T, ContainerT_T, Alloc, true> : public impl::CDirectUniqCacheBase<true, ContainerT_T, Alloc, std::pair<K, T>>,
                                                                    public impl::PropagTypedefs<T, K>
{
...
template<
    ...
    template<typename...> class ContainerT_T,
    typename Alloc>
class NBL_FORCE_EBO CObjectCache<K, T, ContainerT_T, Alloc, false> : public impl::CDirectUniqCacheBase<false, ContainerT_T, Alloc, T, const K>,
                                                                     public impl::PropagTypedefs<T, const K>
{
