...
public:
    ...
    //!
    vector3d(const T* pointerToArray)
        : X(pointerToArray[0]), Y(pointerToArray[1]), Z(pointerToArray[2]) {}
...
template<>
inline vector3d<int32_t> vector3d<int32_t>::operator/(int32_t val) const
{
    return core::vector3d<int32_t>(X / val, Y / val, Z / val);
}
template<>
inline vector3d<int32_t>& vector3d<int32_t>::operator/=(int32_t val)
{
    X /= val;
    Y /= val;
    Z /= val;
