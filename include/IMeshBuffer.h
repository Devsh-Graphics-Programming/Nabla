	...
	class ICPUMeshDataFormatDesc : public IMeshDataFormatDesc<core::ICPUBuffer>, core::BlobSerializable
	{
	    ...
	    public:
			...
			virtual std::string printMemberPackingDebug() const
			{
				...
				sstr << "irr:scene::ICPUMeshDataFormatDesc\n";
				sstr << "mappedAttrBuf " << offsetof(ICPUMeshDataFormatDesc, mappedAttrBuf) << "\n";
				sstr << "mappedIndexBuf " << offsetof(ICPUMeshDataFormatDesc, mappedIndexBuf) << "\n";
				return sstr.str();
			}
...
*/
	...
	public:
		...
		{
			std::ostringstream sstr;
			sstr << "irr:scene::ICPUMeshBuffer\n";
			sstr << "Material " << offsetof(ICPUMeshBuffer, Material) << "\n";
			sstr << "boundingBox " << offsetof(ICPUMeshBuffer, boundingBox) << "\n";
			sstr << "meshLayout " << offsetof(ICPUMeshBuffer, meshLayout) << "\n";
			sstr << "indexType " << offsetof(ICPUMeshBuffer, indexType) << "\n";
			sstr << "baseVertex " << offsetof(ICPUMeshBuffer, baseVertex) << "\n";
			sstr << "indexCount " << offsetof(ICPUMeshBuffer, indexCount) << "\n";
			sstr << "indexBufOffset " << offsetof(ICPUMeshBuffer, indexBufOffset) << "\n";
			sstr << "instanceCount " << offsetof(ICPUMeshBuffer, instanceCount) << "\n";
			sstr << "baseInstance " << offsetof(ICPUMeshBuffer, baseInstance) << "\n";
			sstr << "primitiveType " << offsetof(ICPUMeshBuffer, primitiveType) << "\n";
			sstr << "leakDebugger " << offsetof(ICPUMeshBuffer, leakDebugger) << "\n";
			sstr << "posAttrId " << offsetof(ICPUMeshBuffer, posAttrId) << "\n";
			return sstr.str();
		}
