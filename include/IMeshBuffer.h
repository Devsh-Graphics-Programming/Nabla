...
**/
    ...
    */
	...
	{
        using MaterialType = typename std::conditional<std::is_same<T, core::ICPUBuffer>::value, video::SCPUMaterial, video::SGPUMaterial>::type;
...
*/
	...
	class ICPUMeshBuffer : public IMeshBuffer<core::ICPUBuffer>, public core::BlobSerializable, public asset::IAsset
	{
	    //vertices
	...
	public:
        ...
        virtual size_t conservativeSizeEstimate() const override { return sizeof(IMeshBuffer<core::ICPUBuffer>) + sizeof(posAttrId); }
