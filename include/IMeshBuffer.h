...
*/
	...
	public:
		...
		/** @param ix Index number which is to be returned.
		@returns `ix`th index of mapped attribute buffer or (0, 0, 0, 1) vector if an error occured (e.g. no such index).
		...
		*/
		...
		@returns Pointer to corresponding buffer's data incremented by `baseVertex`
		...
		*/
		...
		//! Accesses given index of given attribute. Index number is incremented by `baseVertex`.
		/** If component count of given attribute is less than 4, only first ones of output vector's members will be written.
		@param[out] output Vector object to which index's value will be returned.
		@param[in] attrId Atrribute id.
		@param[in] ix Index which is to be accessed. Will be incremented by `baseVertex`.
		@returns true if successful or false if an error occured (e.g. no such index or given atrribute's type not implemented).
		@see @ref getBaseVertex() setBaseVertex() getAttribute()
		*/
		...
		//! Sets value of given index of given attribute.
		/** @param input Value which is to be set.
		@param attrId Atrribute id.
		@param ix Index which is to be set. Will be incremented by `baseVertex`.
