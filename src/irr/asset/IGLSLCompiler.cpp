...
#include "irr/asset/CGLSLAMDFixBuiltinIncludeLoader.h"
#include "IReadFile.h"
#include "os.h"
#include <sstream>
#include <regex>
...
IGLSLCompiler::IGLSLCompiler(io::IFileSystem* _fs) : m_inclHandler(core::make_smart_refctd_ptr<CIncludeHandler>(_fs)), m_fs(_fs)
{
    ...
    m_inclHandler->addBuiltinIncludeLoader(core::make_smart_refctd_ptr<asset::CGLSLAMDFixBuiltinIncludeLoader>());
