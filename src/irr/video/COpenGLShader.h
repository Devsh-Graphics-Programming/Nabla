...
class COpenGLShader : public IGPUShader
{
	public:
		...
		COpenGLShader(core::smart_refctd_ptr<asset::ICPUBuffer>&& _glsl, asset::ICPUShader::buffer_contains_glsl_t buffer_contains_glsl) : m_code(std::move(_glsl)), m_containsGLSL(true) {}
