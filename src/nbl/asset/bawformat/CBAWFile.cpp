...
MeshBlobV3::MeshBlobV3(const asset::ICPUMesh* _mesh)
    : box(_mesh->getBoundingBox()), meshBufCnt(_mesh->getMeshBuffers().size())
{
#ifdef OLD_SHADERS
...
// .baw VERSION 1
MeshDataFormatDescBlobV1::MeshDataFormatDescBlobV1(const asset::IMeshDataFormatDesc<asset::ICPUBuffer>* _desc)
    : attrDivisor{0u}
{
...
MeshDataFormatDescBlobV1::MeshDataFormatDescBlobV1(const asset::legacyv0::MeshDataFormatDescBlobV0& _v0blob)
    : attrDivisor{0u}
{
