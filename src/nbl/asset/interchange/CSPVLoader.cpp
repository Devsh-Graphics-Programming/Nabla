...
inline IShader::E_SHADER_STAGE getShaderStageFromSPIRVCrossExecutionModel(spv::ExecutionModel model)
{
    ...
    switch(model)
    {
        case spv::ExecutionModelVertex:
            shaderStage = IShader::ESS_VERTEX;
            break;
        case spv::ExecutionModelTessellationControl:
            shaderStage = IShader::ESS_TESSELATION_CONTROL;
            break;
        case spv::ExecutionModelTessellationEvaluation:
            shaderStage = IShader::ESS_TESSELATION_EVALUATION;
            break;
        case spv::ExecutionModelGeometry:
            shaderStage = IShader::ESS_GEOMETRY;
            break;
        case spv::ExecutionModelFragment:
            shaderStage = IShader::ESS_FRAGMENT;
            break;
        case spv::ExecutionModelGLCompute:
            shaderStage = IShader::ESS_COMPUTE;
            break;
        case spv::ExecutionModelTaskNV:
            shaderStage = IShader::ESS_TASK;
            break;
        case spv::ExecutionModelMeshNV:
            shaderStage = IShader::ESS_MESH;
            break;
        case spv::ExecutionModelRayGenerationKHR:
            shaderStage = IShader::ESS_RAYGEN;
            break;
        case spv::ExecutionModelIntersectionKHR:
            shaderStage = IShader::ESS_INTERSECTION;
            break;
        case spv::ExecutionModelAnyHitKHR:
            shaderStage = IShader::ESS_ANY_HIT;
            break;
        case spv::ExecutionModelClosestHitKHR:
            shaderStage = IShader::ESS_MISS;
            break;
        case spv::ExecutionModelMissKHR:
            shaderStage = IShader::ESS_MISS;
            break;
        case spv::ExecutionModelCallableKHR:
            shaderStage = IShader::ESS_CALLABLE;
            break;
