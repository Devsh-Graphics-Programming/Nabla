...
inline shaderc_shader_kind ESStoShadercEnum(IShader::E_SHADER_STAGE _ss)
{
    ...
    convert[hlsl::findLSB<uint32_t>(IShader::E_SHADER_STAGE::ESS_TESSELLATION_EVALUATION)] = shaderc_tess_evaluation_shader;
    convert[hlsl::findLSB<uint32_t>(IShader::E_SHADER_STAGE::ESS_GEOMETRY)] = shaderc_geometry_shader;
    convert[hlsl::findLSB<uint32_t>(IShader::E_SHADER_STAGE::ESS_FRAGMENT)] = shaderc_fragment_shader;
    convert[hlsl::findLSB<uint32_t>(IShader::E_SHADER_STAGE::ESS_COMPUTE)] = shaderc_compute_shader;
