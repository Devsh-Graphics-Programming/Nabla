...
CGeometryCreator::return_type CGeometryCreator::createCubeMesh(const core::vector3df& size) const
{
    ...
    retval.inputParams = {0b1111u, 0b1u, {{0u, EF_R32G32B32_SFLOAT, offsetof(CubeVertex, pos)}, {0u, EF_R8G8B8A8_UNORM, offsetof(CubeVertex, color)}, {0u, EF_R8G8_USCALED, offsetof(CubeVertex, uv)}, {0u, EF_R8G8B8_SSCALED, offsetof(CubeVertex, normal)}}, {vertexSize, EVIR_PER_VERTEX}};
...
CGeometryCreator::return_type CGeometryCreator::createSphereMesh(float radius, uint32_t polyCountX, uint32_t polyCountY, IMeshManipulator* const meshManipulatorOverride) const
{
    ...
    retval.inputParams = {0b1111u, 0b1u, {{0u, EF_R32G32B32_SFLOAT, offsetof(SphereVertex, pos)}, {0u, EF_R8G8B8A8_UNORM, offsetof(SphereVertex, color)}, {0u, EF_R32G32_SFLOAT, offsetof(SphereVertex, uv)}, {0u, EF_A2B10G10R10_SNORM_PACK32, offsetof(SphereVertex, normal)}}, {vertexSize, EVIR_PER_VERTEX}};
    ...
    uint32_t tesselation, const video::SColor& color, IMeshManipulator* const meshManipulatorOverride) const
{
    ...
    CQuantNormalCache* const quantNormalCache = (meshManipulatorOverride == nullptr) ? defaultMeshManipulator->getQuantNormalCache() : meshManipulatorOverride->getQuantNormalCache();
    retval.inputParams = {0b1111u, 0b1u, {{0u, EF_R32G32B32_SFLOAT, offsetof(CylinderVertex, pos)}, {0u, EF_R8G8B8A8_UNORM, offsetof(CylinderVertex, color)}, {0u, EF_R32G32_SFLOAT, offsetof(CylinderVertex, uv)}, {0u, EF_A2B10G10R10_SNORM_PACK32, offsetof(CylinderVertex, normal)}}, {vertexSize, EVIR_PER_VERTEX}};
...
CGeometryCreator::return_type CGeometryCreator::createRectangleMesh(const core::vector2df_SIMD& _size) const
{
    ...
    retval.inputParams = {0b1111u, 0b1u, {{0u, EF_R32G32B32_SFLOAT, offsetof(RectangleVertex, pos)}, {0u, EF_R8G8B8A8_UNORM, offsetof(RectangleVertex, color)}, {0u, EF_R8G8_USCALED, offsetof(RectangleVertex, uv)}, {0u, EF_R32G32B32_SFLOAT, offsetof(RectangleVertex, normal)}}, {vertexSize, EVIR_PER_VERTEX}};
    // Create indices
    retval.indexCount = 6;
    retval.indexType = asset::EIT_16BIT;
    uint16_t u[6];
...
CGeometryCreator::return_type CGeometryCreator::createDiskMesh(float radius, uint32_t tesselation) const
{
    ...
    retval.inputParams = {0b1111u, 0b1u, {{0u, EF_R32G32B32_SFLOAT, offsetof(DiskVertex, pos)}, {0u, EF_R8G8B8A8_UNORM, offsetof(DiskVertex, color)}, {0u, EF_R8G8_USCALED, offsetof(DiskVertex, uv)}, {0u, EF_R32G32B32_SFLOAT, offsetof(DiskVertex, normal)}}, {vertexSize, EVIR_PER_VERTEX}};
...
public:
    Icosphere(float radius = 1.0f, int subdivision = 1, bool smooth = false)
        : radius(radius), subdivision(subdivision), smooth(smooth), interleavedStride(32)
    {
        if(smooth)
            buildVerticesSmooth();
        else
...
private:
	...
	*/
    ...
    void buildVerticesSmooth()
    {
        ...
        lineIndices.push_back(10);  // 00 - 10
        lineIndices.push_back(1);
        lineIndices.push_back(14);  // 01 - 14
        lineIndices.push_back(2);
        lineIndices.push_back(15);  // 02 - 15
        lineIndices.push_back(3);
        lineIndices.push_back(16);  // 03 - 16
        lineIndices.push_back(4);
        lineIndices.push_back(17);  // 04 - 17
        lineIndices.push_back(10);
        lineIndices.push_back(14);  // 10 - 14
        lineIndices.push_back(14);
        lineIndices.push_back(15);  // 14 - 15
        lineIndices.push_back(15);
        lineIndices.push_back(16);  // 15 - 16
        lineIndices.push_back(16);
        lineIndices.push_back(17);  // 10 - 14
        lineIndices.push_back(17);
        lineIndices.push_back(11);  // 17 - 11
        lineIndices.push_back(10);
        lineIndices.push_back(12);  // 10 - 12
        lineIndices.push_back(12);
        lineIndices.push_back(14);  // 12 - 14
        lineIndices.push_back(14);
        lineIndices.push_back(18);  // 14 - 18
        lineIndices.push_back(18);
        lineIndices.push_back(15);  // 18 - 15
        lineIndices.push_back(15);
        lineIndices.push_back(19);  // 15 - 19
        lineIndices.push_back(19);
        lineIndices.push_back(16);  // 19 - 16
        lineIndices.push_back(16);
        lineIndices.push_back(20);  // 16 - 20
        lineIndices.push_back(20);
        lineIndices.push_back(17);  // 20 - 17
        lineIndices.push_back(17);
        lineIndices.push_back(21);  // 17 - 21
        lineIndices.push_back(21);
        lineIndices.push_back(11);  // 21 - 11
        lineIndices.push_back(12);
        lineIndices.push_back(18);  // 12 - 18
        lineIndices.push_back(18);
        lineIndices.push_back(19);  // 18 - 19
        lineIndices.push_back(19);
        lineIndices.push_back(20);  // 19 - 20
        lineIndices.push_back(20);
        lineIndices.push_back(21);  // 20 - 21
        lineIndices.push_back(21);
        lineIndices.push_back(13);  // 21 - 13
        lineIndices.push_back(5);
        lineIndices.push_back(12);  // 05 - 12
        lineIndices.push_back(6);
        lineIndices.push_back(18);  // 06 - 18
        lineIndices.push_back(7);
        lineIndices.push_back(19);  // 07 - 19
        lineIndices.push_back(8);
        lineIndices.push_back(20);  // 08 - 20
        lineIndices.push_back(9);
        lineIndices.push_back(21);  // 09 - 21
