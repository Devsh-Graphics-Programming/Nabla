...
protected:
    ...
    IDeviceMemoryBacked::SExternalMemoryProperties getExternalMemoryProperties_impl(core::bitflag<asset::IBuffer::E_USAGE_FLAGS> usage, IDeviceMemoryBacked::E_EXTERNAL_HANDLE_TYPE handleType) const override
    {
        ...
        return {
            ...
            .dedicatedOnly   = externalProps.externalMemoryProperties.externalMemoryFeatures & VK_EXTERNAL_MEMORY_FEATURE_DEDICATED_ONLY_BIT ? 1u : 0u,
            .exportable      = externalProps.externalMemoryProperties.externalMemoryFeatures & VK_EXTERNAL_MEMORY_FEATURE_EXPORTABLE_BIT ? 1u : 0u,
            .importable      = externalProps.externalMemoryProperties.externalMemoryFeatures & VK_EXTERNAL_MEMORY_FEATURE_IMPORTABLE_BIT ? 1u : 0u,
        };
    }
