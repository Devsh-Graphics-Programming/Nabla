...
public:
    ...
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GLESgeneral, OpenGLFunctionLoader, glEnableiOES, glDisableiOES, glBlendEquationiOES, glBlendEquationSeparateiOES, glBlendFunciOES, glBlendFuncSeparateiOES, glColorMaskiOES, glIsEnablediOES, glDepthRangeArrayfvOES, glDepthRangef, glViewportArrayvOES, glClipControlEXT);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GLESbuffer, OpenGLFunctionLoader, glBufferStorageEXT);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GLEStexture, OpenGLFunctionLoader, glTexBufferOES, glTexBufferRangeOES, glCopyImageSubDataOES, glTextureViewOES, glTextureViewEXT, glCopyImageSubDataEXT);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GLESdebug, OpenGLFunctionLoader, glDebugMessageControlKHR, glDebugMessageControl, glDebugMessageCallbackKHR, glDebugMessageCallback, glLabelObjectEXT, glObjectLabel  // since ES 3.2
        ,
        glGetObjectLabelEXT, glGetObjectLabel  // since ES 3.2
    );
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GLESdrawing, OpenGLFunctionLoader, glDrawElementsBaseVertexEXT, glDrawRangeElementsBaseVertexEXT, glDrawElementsInstancedBaseVertexEXT, glDrawElementsInstancedBaseInstanceEXT, glDrawArraysInstancedBaseInstanceEXT, glDrawElementsBaseVertexOES, glDrawElementsInstancedBaseVertexOES, glDrawElementsInstancedBaseVertexBaseInstanceEXT, glDrawRangeElementsBaseVertexOES, glMultiDrawArraysIndirectEXT, glMultiDrawElementsIndirectEXT);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GLESfragment, OpenGLFunctionLoader, glMinSampleShading, glMinSampleShadingOES);
        ...
        else if(features->isFeatureAvailable(COpenGLFeatureMap::NBL_EXT_debug_label))
        {
            switch(id)
            {
                ...
                case GL_PROGRAM_PIPELINE:
                    id = GL_PROGRAM_PIPELINE_OBJECT_EXT;
                    break;
