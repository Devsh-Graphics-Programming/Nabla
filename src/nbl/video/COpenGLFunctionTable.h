...
public:
    ...
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GL4frameBuffer, OpenGLFunctionLoader, glBlitNamedFramebuffer, glCreateFramebuffers, glCheckNamedFramebufferStatus, glCheckNamedFramebufferStatusEXT, glFramebufferTexture, glNamedFramebufferTexture, glNamedFramebufferTextureEXT, glNamedFramebufferTextureLayer, glNamedFramebufferTextureLayerEXT, glFramebufferTexture1D, glFramebufferTexture3D, glNamedFramebufferTexture2DEXT, glNamedFramebufferDrawBuffers, glFramebufferDrawBuffersEXT, glDrawBuffer, glNamedFramebufferDrawBuffer, glFramebufferDrawBufferEXT, glNamedFramebufferReadBuffer, glFramebufferReadBufferEXT, glClearNamedFramebufferiv, glClearNamedFramebufferuiv, glClearNamedFramebufferfv, glClearNamedFramebufferfi);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GL4buffer, OpenGLFunctionLoader, glBindBuffersBase, glBindBuffersRange, glCreateBuffers, glBufferStorage, glNamedBufferStorage, glNamedBufferStorageEXT, glNamedBufferSubData, glNamedBufferSubDataEXT, glGetBufferSubData, glGetNamedBufferSubData, glGetNamedBufferSubDataEXT, glMapBuffer, glMapNamedBuffer, glMapNamedBufferEXT, glMapNamedBufferRange, glMapNamedBufferRangeEXT, glFlushMappedNamedBufferRange, glFlushMappedNamedBufferRangeEXT, glUnmapNamedBuffer, glUnmapNamedBufferEXT, glClearBufferData, glClearNamedBufferData, glClearNamedBufferDataEXT, glClearBufferSubData, glClearNamedBufferSubData, glClearNamedBufferSubDataEXT, glCopyNamedBufferSubData, glNamedCopyBufferSubDataEXT, glGetNamedBufferParameteri64v, glGetNamedBufferParameteriv, glGetNamedBufferParameterivEXT);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GL4texture, OpenGLFunctionLoader, glBindTextures, glCreateTextures, glTexStorage1D, glTexStorage3DMultisample, glTextureStorage1D, glTextureStorage2D, glTextureStorage3D, glTextureStorage2DMultisample, glTextureStorage3DMultisample, glTextureBuffer, glTextureBufferRange, glTextureView, glTextureStorage1DEXT, glTextureStorage2DEXT, glTextureStorage3DEXT, glTextureBufferEXT, glTextureBufferRangeEXT, glTextureStorage2DMultisampleEXT, glTextureStorage3DMultisampleEXT, glGetTextureImage, glGetTextureImageEXT, glGetCompressedTextureImage, glGetCompressedTextureImageEXT, glGetCompressedTexImage, glMultiTexSubImage1DEXT, glMultiTexSubImage2DEXT, glMultiTexSubImage3DEXT, glTexSubImage1D, glTextureSubImage1D, glTextureSubImage2D, glTextureSubImage3D, glTextureSubImage1DEXT, glTextureSubImage2DEXT, glTextureSubImage3DEXT, glCompressedTexSubImage1D, glCompressedTextureSubImage1D, glCompressedTextureSubImage2D, glCompressedTextureSubImage3D, glCompressedTextureSubImage1DEXT, glCompressedTextureSubImage2DEXT, glCompressedTextureSubImage3DEXT, glCopyImageSubData, glTextureParameterIuiv, glTextureParameterIuivEXT, glTexParameterIuiv, glGenerateTextureMipmap, glGenerateTextureMipmapEXT, glClampColor, glCreateSamplers, glBindSamplers, glBindImageTextures, glGetTextureHandleARB, glGetTextureSamplerHandleARB, glMakeTextureHandleResidentARB, glMakeTextureHandleNonResidentARB, glGetImageHandleARB, glMakeImageHandleResidentARB, glMakeImageHandleNonResidentARB, glIsTextureHandleResidentARB, glIsImageHandleResidentARB, glGetTextureHandleNV, glGetTextureSamplerHandleNV, glMakeTextureHandleNonResidentNV, glGetImageHandleNV, glMakeImageHandleResidentNV, glMakeImageHandleNonResidentNV, glIsTextureHandleResidentNV, glIsImageHandleResidentNV, glMakeTextureHandleResidentNV, glGetTexImage, glTextureParameteriv);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GL4shader, OpenGLFunctionLoader, glCreateProgramPipelines, glPatchParameterfv, glPatchParameteri, glPrimitiveRestartIndex, glProvokingVertex, glLogicOp, glPolygonMode);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GL4fragment, OpenGLFunctionLoader, glPointParameterf, glPointParameterfv, glBlendEquationEXT, glDepthRangeIndexed, glViewportIndexedfv, glScissorIndexedv, glMinSampleShading, glBlendEquationSeparatei, glBlendFuncSeparatei, glColorMaski, glBlendFuncIndexedAMD, glBlendFunciARB, glBlendEquationIndexedAMD, glBlendEquationiARB);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GL4vertex, OpenGLFunctionLoader, glCreateVertexArrays, glVertexArrayElementBuffer, glVertexArrayVertexBuffer, glVertexArrayBindVertexBufferEXT, glVertexArrayAttribBinding, glVertexArrayVertexAttribBindingEXT, glEnableVertexArrayAttrib, glEnableVertexArrayAttribEXT, glDisableVertexArrayAttrib, glDisableVertexArrayAttribEXT, glVertexAttribLFormat, glVertexArrayAttribFormat, glVertexArrayAttribIFormat, glVertexArrayAttribLFormat, glVertexArrayVertexAttribFormatEXT, glVertexArrayVertexAttribIFormatEXT, glVertexArrayVertexAttribLFormatEXT, glVertexArrayBindingDivisor, glVertexArrayVertexBindingDivisorEXT);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GL4drawing, OpenGLFunctionLoader, glDrawArraysInstancedBaseInstance, glDrawElementsInstancedBaseInstance, glDrawElementsInstancedBaseVertex, glDrawElementsInstancedBaseVertexBaseInstance, glDrawTransformFeedback, glDrawTransformFeedbackInstanced, glDrawTransformFeedbackStream, glDrawTransformFeedbackStreamInstanced, glMultiDrawArraysIndirect, glMultiDrawElementsIndirect, glMultiDrawArraysIndirectCount, glMultiDrawElementsIndirectCount, glMultiDrawArraysIndirectCountARB, glMultiDrawElementsIndirectCountARB);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GL4query, OpenGLFunctionLoader, glCreateQueries, glGetQueryBufferObjectuiv, glGetQueryBufferObjectui64v, glBeginConditionalRender, glEndConditionalRender);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GL4general, OpenGLFunctionLoader, glGetFloati_v, glGetInternalformati64v, glClipControl, glDepthRangeArrayv, glDepthRange, glViewportArrayv);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GL4_sync, OpenGLFunctionLoader, glTextureBarrier, glTextureBarrierNV);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GL4debug, OpenGLFunctionLoader, glDebugMessageControl, glDebugMessageControlARB, glDebugMessageCallback, glDebugMessageCallbackARB, glObjectLabel, glGetObjectLabel);
    ...
    void extGlNamedFramebufferTexture(GLuint framebuffer, GLenum attachment, GLuint texture, GLint level, GLenum textureType) override
    {
        if(!features->needsDSAFramebufferHack)
        {
            ...
            base_t::extGlNamedFramebufferTexture(framebuffer, attachment, texture, level, textureType);
    }
    ...
    void extGlCreateBuffers(GLsizei n, GLuint* buffers) override
    {
        if(features->Version >= 450 || features->FeatureAvailable[features->EOpenGLFeatures::NBL_ARB_direct_state_access])
        {
            ...
            base_t::extGlCreateBuffers(n, buffers);
    }
    ...
    void extGlBindBuffersBase(const GLenum& target, const GLuint& first, const GLsizei& count, const GLuint* buffers) override
    {
        if(features->Version >= 440 || features->FeatureAvailable[features->EOpenGLFeatures::NBL_ARB_multi_bind])
        {
            ...
            base_t::extGlBindBuffersBase(target, first, count, buffers);
    }
    ...
    void extGlBindBuffersRange(const GLenum& target, const GLuint& first, const GLsizei& count, const GLuint* buffers, const GLintptr* offsets, const GLsizeiptr* sizes) override
    {
        if(features->Version >= 440 || features->FeatureAvailable[features->EOpenGLFeatures::NBL_ARB_multi_bind])
        {
            ...
            base_t::extGlBindBuffersRange(target, first, count, buffers, offsets, sizes);
    }
    ...
    void extGlCopyImageSubData(
        ...
        GLsizei srcWidth, GLsizei srcHeight, GLsizei srcDepth) override
    {
