...
IDescriptorSetCache::IDescriptorSetCache(ILogicalDevice* device, core::smart_refctd_ptr<IDescriptorPool>&& _descPool, core::smart_refctd_ptr<IGPUDescriptorSetLayout>&& _canonicalLayout)
    : IDescriptorSetCache(device, _descPool->getCapacity())
{
