...
IPropertyPool::IPropertyPool(uint32_t capacity, void* reserved, bool contiguous)
    : indexAllocator(reserved, 0u, 0u, PROPERTY_ADDRESS_ALLOCATOR_ARGS), m_indexToAddr(nullptr), m_addrToIndex(nullptr)
{
    if(contiguous)
    {
