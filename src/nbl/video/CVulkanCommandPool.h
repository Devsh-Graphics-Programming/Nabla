#ifndef _NBL_C_VULKAN_COMMAND_POOL_H_INCLUDED_
#define _NBL_C_VULKAN_COMMAND_POOL_H_INCLUDED_
...
{
    public:
        CVulkanCommandPool(core::smart_refctd_ptr<const ILogicalDevice>&& dev, const core::bitflag<IGPUCommandPool::CREATE_FLAGS> flags, const uint32_t queueFamilyIndex, VkCommandPool vk_commandPool)
