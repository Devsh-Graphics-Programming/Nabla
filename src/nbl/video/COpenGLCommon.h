...
{
public:
    SOpenGLBarrierHelper(const COpenGLFeatureMap* features)
        : TransformFeedbackBit(0),  // we dont expose transform feedback
    ...
    inline GLbitfield pipelineStageFlagsToMemoryBarrierBits(asset::E_PIPELINE_STAGE_FLAGS srcflags, asset::E_PIPELINE_STAGE_FLAGS dstflags) const
    {
        ...
        const GLbitfield consumerBits[PipelineStageCount] = {
            // dst stage mask
