...
void ILogicalDevice::addCommonShaderDefines(const bool runningInRenderdoc)
{
    ...
    
    {
        ...
        addShaderDefineToPool(pool,"NBL_REQUIRED_SUBGROUP_SIZE_STAGES", limits.requiredSubgroupSizeStages);
        ...
        addShaderDefineToPool(pool,"NBL_ROBUST_STORAGE_BUFFER_ACCESS_SIZE_ALIGNMENT", limits.robustStorageBufferAccessSizeAlignment);
        addShaderDefineToPool(pool,"NBL_ROBUST_UNIFORM_BUFFER_ACCESS_SIZE_ALIGNMENT", limits.robustUniformBufferAccessSizeAlignment);
        ...
        addShaderDefineToPool(pool,"NBL_SPIRV_VERSION", limits.spirvVersion);
    }
