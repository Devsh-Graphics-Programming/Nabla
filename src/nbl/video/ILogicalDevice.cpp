...
void ILogicalDevice::addCommonShaderDefines(const bool runningInRenderdoc)
{
    ...
    
    {
        ...
        //if (limits.displayTiming) addShaderDefineToPool(pool,"NBL_DISPLAY_TIMING"); // shader doesn't need to know
