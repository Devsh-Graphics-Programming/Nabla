...
{
	public:
		COpenGLShader(core::smart_refctd_ptr<const ILogicalDevice>&& dev, core::smart_refctd_ptr<asset::ICPUBuffer>&& _spirv);
		COpenGLShader(core::smart_refctd_ptr<const ILogicalDevice>&& dev, core::smart_refctd_ptr<asset::ICPUBuffer>&& _glsl, buffer_contains_glsl_t buffer_contains_glsl);
