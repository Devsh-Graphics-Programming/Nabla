...
public:
    ...
    public:
        OpenGLFunctionLoader()
            : egl(nullptr) {}
        explicit OpenGLFunctionLoader(const egl::CEGL* _egl)
            : egl(_egl) {}
    ...
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GLframeBuffer, OpenGLFunctionLoader, glBlitFramebuffer, glDeleteFramebuffers, glGenFramebuffers, glBindFramebuffer, glCheckFramebufferStatus, glFramebufferTexture, glFramebufferTextureLayer, glFramebufferTexture2D, glClearBufferiv, glClearBufferuiv, glClearBufferfv, glClearBufferfi, glDrawBuffers, glReadBuffer);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GL_sync, OpenGLFunctionLoader, glFenceSync, glDeleteSync, glClientWaitSync, glWaitSync, glMemoryBarrier);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GLbuffer, OpenGLFunctionLoader, glBindBufferBase, glBindBufferRange, glGenBuffers, glBindBuffer, glDeleteBuffers, glBufferSubData, glMapBufferRange, glFlushMappedBufferRange, glUnmapBuffer, glCopyBufferSubData, glIsBuffer, glGetBufferParameteri64v, glGetBufferParameteriv);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GLtexture, OpenGLFunctionLoader, glActiveTexture, glTexStorage2D, glTexStorage3D, glTexStorage2DMultisample, glTexStorage3DMultisample, glTexSubImage3D, glCompressedTexSubImage2D, glCompressedTexSubImage3D, glGenerateMipmap, glGenSamplers, glDeleteSamplers, glBindSampler, glSamplerParameteri, glSamplerParameterf, glSamplerParameterfv, glBindImageTexture, glBindTexture, glTexSubImage2D, glTexBuffer, glTexBufferRange, glDeleteTextures, glGenTextures, glTexParameteriv, glCopyImageSubData, glReadPixels, glGetTextureSubImage, glGetCompressedTextureSubImage);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GLshader, OpenGLFunctionLoader, glCreateShader, glCreateShaderProgramv
        //, glCreateProgramPipelines
        ,
        glGenProgramPipelines, glDeleteProgramPipelines, glUseProgramStages, glShaderSource, glCompileShader, glCreateProgram, glAttachShader, glTransformFeedbackVaryings, glLinkProgram, glUseProgram, glDeleteProgram, glDeleteShader, glGetAttachedShaders, glGetShaderInfoLog, glGetProgramInfoLog, glGetShaderiv, glGetProgramiv, glGetUniformLocation, glProgramUniform1fv, glProgramUniform2fv, glProgramUniform3fv, glProgramUniform4fv, glProgramUniform1iv, glProgramUniform2iv, glProgramUniform3iv, glProgramUniform4iv, glProgramUniform1uiv, glProgramUniform2uiv, glProgramUniform3uiv, glProgramUniform4uiv, glProgramUniformMatrix2fv, glProgramUniformMatrix3fv, glProgramUniformMatrix4fv, glProgramUniformMatrix2x3fv, glProgramUniformMatrix3x2fv, glProgramUniformMatrix4x2fv, glProgramUniformMatrix2x4fv, glProgramUniformMatrix3x4fv, glProgramUniformMatrix4x3fv, glGetActiveUniform, glBindProgramPipeline, glGetProgramBinary, glProgramBinary, glProgramParameteri, glDepthMask, glPixelStorei, glPolygonOffset
        //, glPointSize
        ,
        glLineWidth, glDepthFunc, glHint, glFrontFace, glCullFace, glGetProgramPipelineiv);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GLfragment, OpenGLFunctionLoader, glBlendEquation, glBlendColor, glSampleCoverage, glSampleMaski, glStencilFuncSeparate, glStencilOpSeparate, glStencilMaskSeparate, glBlendFuncSeparate, glDepthRangef);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GLvertex, OpenGLFunctionLoader, glGenVertexArrays, glDeleteVertexArrays, glBindVertexArray, glBindVertexBuffer, glVertexAttribBinding, glEnableVertexAttribArray, glDisableVertexAttribArray, glVertexAttribFormat, glVertexAttribIFormat, glVertexBindingDivisor);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GLdrawing, OpenGLFunctionLoader, glDrawArrays, glDrawElements, glDrawArraysInstanced, glDrawElementsInstanced, glDrawArraysIndirect, glDrawElementsIndirect);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GLtransformFeedback, OpenGLFunctionLoader, glGenTransformFeedbacks, glDeleteTransformFeedbacks, glBindTransformFeedback, glBeginTransformFeedback, glPauseTransformFeedback, glResumeTransformFeedback, glEndTransformFeedback);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GLquery, OpenGLFunctionLoader, glGenQueries, glDeleteQueries, glIsQuery, glBeginQuery, glEndQuery, glBeginQueryIndexed, glEndQueryIndexed, glQueryCounter, glGetQueryiv, glGetQueryObjectuiv, glGetQueryObjectui64v);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GLgeneral, OpenGLFunctionLoader, glEnablei, glDisablei, glEnable, glDisable, glIsEnabledi
        //glGet functions
        ,
        glGetIntegerv, glGetBooleanv
        //, glGetDoublev
        ,
        glGetFloatv, glGetString
        //, glGetFloati_v
        ,
        glGetInteger64v, glGetIntegeri_v, glGetBooleani_v, glGetStringi
        ...
        ,
        glBlendEquationi, glBlendEquationSeparatei, glBlendFunci, glBlendFuncSeparatei, glColorMaski, glViewport, glGetError);
    NBL_SYSTEM_DECLARE_DYNAMIC_FUNCTION_CALLER_CLASS(GLcompute, OpenGLFunctionLoader, glDispatchCompute, glDispatchComputeIndirect);
    ...
    virtual void extGlCopyImageSubData(
        ...
        GLsizei srcWidth, GLsizei srcHeight, GLsizei srcDepth) = 0;
