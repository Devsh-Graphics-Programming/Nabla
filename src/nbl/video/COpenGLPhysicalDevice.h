...
public:
	static core::smart_refctd_ptr<COpenGLPhysicalDevice> create(core::smart_refctd_ptr<system::ISystem>&& s, core::smart_refctd_ptr<asset::IGLSLCompiler>&& glslc, const egl::CEGL* _egl, SDebugCallback* dbgCb, core::smart_refctd_ptr<system::ILogger>&& logger)
	{
...
protected:
	...
	{
		return core::make_smart_refctd_ptr<COpenGLLogicalDevice>(m_egl, &m_glfeatures, m_config, m_gl_major, m_gl_minor, params, m_dbgCb, core::smart_refctd_ptr(m_system), core::smart_refctd_ptr(m_GLSLCompiler), core::smart_refctd_ptr(m_logger));
	}

private:
    COpenGLPhysicalDevice(core::smart_refctd_ptr<system::ISystem>&& s, core::smart_refctd_ptr<asset::IGLSLCompiler>&& glslc, const egl::CEGL* _egl, EGLConfig config, EGLContext ctx, EGLint major, EGLint minor, SDebugCallback* dbgCb, core::smart_refctd_ptr<system::ILogger>&& logger) :
