...
protected:
	...
	{
		return core::make_smart_refctd_ptr<COpenGLLogicalDevice>(m_egl, this, &m_glfeatures, m_config, m_gl_major, m_gl_minor, params, m_dbgCb, core::smart_refctd_ptr(m_system), core::smart_refctd_ptr(m_GLSLCompiler), system::logger_opt_smart_ptr(m_logger));
	}
