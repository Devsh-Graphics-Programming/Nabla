...
namespace nbl::ui
{
    ...
    //             xcb.pxcb_send_event(m_connection->getNativeHandle(), false,
    //                         sne->requestor,
    ...
    //                 }
    //                 xcb_get_property_cookie_t cookie = xcb.pxcb_get_property(m_connection->getNativeHandle(), true, 
    //                     sne->requestor,
    //                     sne->property, 
    //                     fieldType, 0, 0x1fffffff); // 0x1fffffff = INT32_MAX / 4
    //                 if(xcb_get_property_reply_t* reply =
    //                     xcb.pxcb_get_property_reply(m_connection->getNativeHandle(), cookie, nullptr)) {
