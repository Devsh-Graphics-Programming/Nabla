...
public:
	...
	void onAppInitialized_impl() override
	{
		...
		CommonAPI::Init(initOutput, nbl::video::EAT_OPENGL, "Subgroup Arithmetic Test");
	...
	private:
		...
		std::array<nbl::video::IGPUQueue*, INIT_OUTPUT::EQT_COUNT> queues = { nullptr, nullptr, nullptr };
