...
int main()
{
	...
	asset::SBufferRange<video::IGPUBuffer> computeUBORange{ 0, core::roundUp(sizeof(UBOCompute), 64ull), gpuUboCompute };
	asset::SBufferRange<video::IGPUBuffer> graphicsUBORange{ 0, gpuUboGaphics->getSize(), gpuUboGaphics };
