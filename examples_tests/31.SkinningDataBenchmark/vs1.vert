...
void linearSkin(out vec3 skinnedPos, out vec3 skinnedNormal, in ivec4 boneIDs, in vec4 boneWeightsXYZBoneCountNormalized)
{
    ...
    int boneOffset = gl_InstanceID*BONE_CNT*7 + boneIDs.x*7;
    //global matrix
    ...
    {
        boneOffset = gl_InstanceID*BONE_CNT*7 + boneIDs.y*7;
        //global matrix
    ...
    {
        boneOffset = gl_InstanceID*BONE_CNT*7 + boneIDs.z*7;
        //global matrix
    ...
    {
        boneOffset = gl_InstanceID*BONE_CNT*7 + boneIDs.w*7;
        //global matrix
