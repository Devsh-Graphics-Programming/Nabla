...
constexpr std::initializer_list<std::string_view> gliTestingPaths =
{
	...
	*/
	...
	//"../../media/GLI/array_r8_uint.dds",				// I think it's something with mipmaps - especially your offsets in state																							>   imagemanipulatortest_d.exe!irr::asset::CGLIWriter::writeGLIFile::__l2::<lambda>(unsigned int ptrOffset, const irr::core::vectorSIMD_32<unsigned int> & texelCoord) Line 170	C++
	//"../../media/GLI/cube_rgba8_unorm.dds",			// cube seems to work, but beware that you missed something with faces - each second one is missing
