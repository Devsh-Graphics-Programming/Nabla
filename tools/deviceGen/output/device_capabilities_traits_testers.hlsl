...
NBL_GENERATE_MEMBER_TESTER(sparseAddressSpaceSize);
NBL_GENERATE_MEMBER_TESTER(maxBoundDescriptorSets);
...
NBL_GENERATE_MEMBER_TESTER(maxVertexInputAttributes);
NBL_GENERATE_MEMBER_TESTER(maxVertexInputBindings);
NBL_GENERATE_MEMBER_TESTER(maxVertexInputAttributeOffset);
NBL_GENERATE_MEMBER_TESTER(maxVertexInputBindingStride);
...
NBL_GENERATE_MEMBER_TESTER(maxDrawIndexedIndexValue);
...
NBL_GENERATE_MEMBER_TESTER(protectedNoFault);
NBL_GENERATE_MEMBER_TESTER(maxPerSetDescriptors);
NBL_GENERATE_MEMBER_TESTER(maxMemoryAllocationSize);
// VK 1.2
NBL_GENERATE_MEMBER_TESTER(denormBehaviorIndependence);
NBL_GENERATE_MEMBER_TESTER(roundingModeIndependence);
NBL_GENERATE_MEMBER_TESTER(shaderSignedZeroInfNanPreserveFloat16);
NBL_GENERATE_MEMBER_TESTER(shaderSignedZeroInfNanPreserveFloat32);
...
NBL_GENERATE_MEMBER_TESTER(maxTimelineSemaphoreValueDifference);
NBL_GENERATE_MEMBER_TESTER(framebufferIntegerColorSampleCounts);
// VK 1.3
...
NBL_GENERATE_MEMBER_TESTER(sampleRateShading);
NBL_GENERATE_MEMBER_TESTER(dualSrcBlend);
NBL_GENERATE_MEMBER_TESTER(logicOp);
NBL_GENERATE_MEMBER_TESTER(fillModeNonSolid);
...
NBL_GENERATE_MEMBER_TESTER(multiViewport);
NBL_GENERATE_MEMBER_TESTER(samplerAnisotropy);
NBL_GENERATE_MEMBER_TESTER(occlusionQueryPrecise);
NBL_GENERATE_MEMBER_TESTER(pipelineStatisticsQuery);
NBL_GENERATE_MEMBER_TESTER(shaderImageGatherExtended);
NBL_GENERATE_MEMBER_TESTER(shaderStorageImageExtendedFormats);
NBL_GENERATE_MEMBER_TESTER(shaderStorageImageMultisample);
NBL_GENERATE_MEMBER_TESTER(shaderStorageImageWriteWithoutFormat);
NBL_GENERATE_MEMBER_TESTER(shaderStorageImageArrayDynamicIndexing);
NBL_GENERATE_MEMBER_TESTER(shaderClipDistance);
NBL_GENERATE_MEMBER_TESTER(shaderCullDistance);
NBL_GENERATE_MEMBER_TESTER(shaderFloat64);
NBL_GENERATE_MEMBER_TESTER(shaderInt64);
NBL_GENERATE_MEMBER_TESTER(shaderInt16);
NBL_GENERATE_MEMBER_TESTER(variableMultisampleRate);
NBL_GENERATE_MEMBER_TESTER(inheritedQueries);
// VK 1.1
NBL_GENERATE_MEMBER_TESTER(storageBuffer16BitAccess);
NBL_GENERATE_MEMBER_TESTER(uniformAndStorageBuffer16BitAccess);
NBL_GENERATE_MEMBER_TESTER(multiview);
NBL_GENERATE_MEMBER_TESTER(protectedMemory);
NBL_GENERATE_MEMBER_TESTER(samplerYcbcrConversion);
NBL_GENERATE_MEMBER_TESTER(shaderDrawParameters);
// VK 1.2
NBL_GENERATE_MEMBER_TESTER(uniformAndStorageBuffer8BitAccess);
NBL_GENERATE_MEMBER_TESTER(storagePushConstant8);
NBL_GENERATE_MEMBER_TESTER(shaderInt8);
NBL_GENERATE_MEMBER_TESTER(descriptorIndexing);
...
NBL_GENERATE_MEMBER_TESTER(shaderStorageImageArrayNonUniformIndexing);
NBL_GENERATE_MEMBER_TESTER(shaderInputAttachmentArrayNonUniformIndexing);
NBL_GENERATE_MEMBER_TESTER(shaderUniformTexelBufferArrayNonUniformIndexing);
NBL_GENERATE_MEMBER_TESTER(shaderStorageTexelBufferArrayNonUniformIndexing);
NBL_GENERATE_MEMBER_TESTER(bufferDeviceAddressCaptureReplay);
NBL_GENERATE_MEMBER_TESTER(bufferDeviceAddressMultiDevice);
NBL_GENERATE_MEMBER_TESTER(vulkanMemoryModelAvailabilityVisibilityChains);
NBL_GENERATE_MEMBER_TESTER(subgroupBroadcastDynamicId);
// VK 1.3
NBL_GENERATE_MEMBER_TESTER(descriptorBindingInlineUniformBlockUpdateAfterBind);
// Nabla Core Extensions
