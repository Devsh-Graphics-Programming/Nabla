...
NBL_GENERATE_MEMBER_TESTER(maxComputeWorkGroupCount[3]);
...
NBL_GENERATE_MEMBER_TESTER(E_POINT_CLIPPING_BEHAVIOR : uint8_t);
...
NBL_GENERATE_MEMBER_TESTER(sampleLocationCoordinateRange[2]);
...
NBL_GENERATE_MEMBER_TESTER(textureCompressionETC2);
NBL_GENERATE_MEMBER_TESTER(textureCompressionASTC_LDR);
NBL_GENERATE_MEMBER_TESTER(textureCompressionBC);
...
NBL_GENERATE_MEMBER_TESTER(privateData);
// Nabla Core Extensions
