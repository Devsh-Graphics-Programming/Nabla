    ...
    // Roadmap 2022 requires support for these, device support is ubiquitous and enablement is unlikely to harm performance
    // [REQUIRE]
    ...
    // Will eventually be required by HLSL202x if it implements references or pointers (even the non-generic type)
    // [REQUIRE]
    // bool variablePointers = true;
    // [REQUIRE]
    // bool variablePointersStorageBuffer = true;
    // [DO NOT EXPOSE] not gonna expose until we have a need to or via VkPhysicalDeviceProtectedMemoryProperties provided by Vulkan 1.1
    // bool protectedMemory = DISABLE;
    ...
    // bool samplerYcbcrConversion = DISABLE;
    ...
    // [REQUIRE] ALIAS: VK_KHR_sampler_mirror_clamp_to_edge
    ...
    // ROADMAP 2024 and good device coverage
    ...
    // [REQUIRE] or VK_EXT_scalar_block_layout
    ...
    // [REQUIRE] or VK_KHR_imageless_framebuffer
    // bool imagelessFramebuffer = DISABLE;
    // Vulkan 1.2 requires these
    // [REQUIRE] or VK_KHR_uniform_buffer_standard_layout
    // bool uniformBufferStandardLayout = true;
    // [REQUIRE] or VK_KHR_shader_subgroup_extended_types
    // bool shaderSubgroupExtendedTypes = true;
    // [REQUIRE] or VK_KHR_separate_depth_stencil_layouts
    // bool separateDepthStencilLayouts = true;
    // [REQUIRE] or VK_EXT_host_query_reset [TODO Implement]
    // bool hostQueryReset = true;
    // [REQUIRE] or VK_KHR_timeline_semaphore [TODO Implement]
    ...
    // ROADMAP2022 wants them. ALIAS VK_KHR_vulkan_memory_model
    // [REQUIRE]
    ...
    // [REQUIRE]
    // bool inlineUniformBlock = DISABLE;
    // ROADMAP 2022, Nabla Core Profile:
    // bool descriptorBindingInlineUniformBlockUpdateAfterBind = DISABLE;
    // Vulkan 1.3 non-optional and Nabla Core Profile but TODO: need impl
    // [REQUIRE] or VK_EXT_pipeline_creation_cache_control
    ...
    // [REQUIRE] or VK_EXT_private_data
    ...
    // Nabla Core Profile, Vulkan 1.3 or VK_EXT_subgroup_size_control
    // [REQUIRE]
    // bool subgroupSizeControl = true;
    // [REQUIRE]
    // bool computeFullSubgroups = true;
    // REQUIRE
    // [REQUIRE] or VK_KHR_synchronization2
    ...
    // [DO NOT EXPOSE] EVIL
    // [REQUIRE] or VK_KHR_dynamic_rendering
    // bool dynamicRendering = DISABLE;
    // Vulkan 1.3 non-optional requires, you probably want to look at the individual limits anyway
    // [REQUIRE] or VK_KHR_shader_integer_dot_product
    ...
    // [REQUIRE] [DO NOT EXPOSE] Vulkan feature requirements
