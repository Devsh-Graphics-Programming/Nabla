...
NBL_CONSTEXPR_STATIC_INLINE core::bitflag<asset::IImage::E_SAMPLE_COUNT_FLAGS> sampleLocationSampleCounts = )===" + CJITIncludeLoader::to_string(limits.sampleLocationSampleCounts) + R"===(;
...
NBL_CONSTEXPR_STATIC_INLINE core::bitflag<asset::IShader::E_SHADER_STAGE> cooperativeMatrixSupportedStages = )===" + CJITIncludeLoader::to_string(limits.cooperativeMatrixSupportedStages) + R"===(;
...
NBL_CONSTEXPR_STATIC_INLINE bool textureCompressionETC2 = )===" + CJITIncludeLoader::to_string(features.textureCompressionETC2) + R"===(;
NBL_CONSTEXPR_STATIC_INLINE bool textureCompressionASTC_LDR = )===" + CJITIncludeLoader::to_string(features.textureCompressionASTC_LDR) + R"===(;
NBL_CONSTEXPR_STATIC_INLINE bool textureCompressionBC = )===" + CJITIncludeLoader::to_string(features.textureCompressionBC) + R"===(;
NBL_CONSTEXPR_STATIC_INLINE bool pipelineStatisticsQuery = )===" + CJITIncludeLoader::to_string(features.pipelineStatisticsQuery) + R"===(;
NBL_CONSTEXPR_STATIC_INLINE bool vertexPipelineStoresAndAtomics = )===" + CJITIncludeLoader::to_string(features.vertexPipelineStoresAndAtomics) + R"===(;
NBL_CONSTEXPR_STATIC_INLINE bool fragmentStoresAndAtomics = )===" + CJITIncludeLoader::to_string(features.fragmentStoresAndAtomics) + R"===(;
NBL_CONSTEXPR_STATIC_INLINE bool shaderTessellationAndGeometryPointSize = )===" + CJITIncludeLoader::to_string(features.shaderTessellationAndGeometryPointSize) + R"===(;
...
NBL_CONSTEXPR_STATIC_INLINE bool shaderStorageImageReadWithoutFormat = )===" + CJITIncludeLoader::to_string(features.shaderStorageImageReadWithoutFormat) + R"===(;
...
NBL_CONSTEXPR_STATIC_INLINE bool privateData = )===" + CJITIncludeLoader::to_string(features.privateData) + R"===(;
// Nabla Core Extensions
...
// Extensions
NBL_CONSTEXPR_STATIC_INLINE core::bitflag<E_SWAPCHAIN_MODE> swapchainMode = )===" + CJITIncludeLoader::to_string(features.swapchainMode) + R"===(;
