...
#include "irr/irrunpack.h"
	...
	{
	public:
		static const asset::material_compiler::IR::INode* translateMixIntoBlends(asset::material_compiler::IR* ir, const asset::material_compiler::IR::INode* _mix)
		{
		...
		static std::pair<instr_t, const asset::material_compiler::IR::INode*> processSubtree(asset::material_compiler::IR* ir, const asset::material_compiler::IR::INode* tree, asset::material_compiler::IR::INode::children_array_t& next)
		{
			using namespace asset::material_compiler;

			auto isTwosided = [](const asset::material_compiler::IR::INode* _node, size_t _frontSurfIx, IR::INode::children_array_t& _frontSurfChildren) -> bool
			{
				bool ts = false;
	...
	protected:
		...
		std::pair<instr_t, const asset::material_compiler::IR::INode*> processSubtree(const asset::material_compiler::IR::INode* tree, asset::material_compiler::IR::INode::children_array_t& next)
		{
			//TODO deduplication
			return CInterpreter::processSubtree(m_ir, tree, next);
		}

		void setBSDFData(SBSDFUnion& _dst, E_OPCODE _op, const asset::material_compiler::IR::INode* _node) const
		{
			using namespace asset::material_compiler;
		...
		template <typename ...Params>
		bool push(const instr_t _instr, const asset::material_compiler::IR::INode* _node, const asset::material_compiler::IR::INode::children_array_t& _children, instr_t _parent, Params&& ...args)
		{
			bool pushIt = false;
		...
		instr_t finalizeInstr(instr_t _instr, const asset::material_compiler::IR::INode* _node, uint32_t _bsdfBufOffset)
		{
			using namespace asset::material_compiler;
	...
	public:
		ITraveralGenerator(SContext* _ctx, asset::material_compiler::IR* _ir) : m_ctx(_ctx), m_ir(_ir) {}

		virtual traversal_t genTraversal(const asset::material_compiler::IR::INode* _root) = 0;
...
namespace remainder_and_pdf
{
	...
	{
		instr_t instr;
		const asset::material_compiler::IR::INode* node;
		asset::material_compiler::IR::INode::children_array_t children;
		bool visited;
	};
	...
	public:
		...
		traversal_t genTraversal(const asset::material_compiler::IR::INode* _root) override
		{
			using namespace asset::material_compiler;
